namespace Net.Common
{
    ...
    public class SysInfo
    {
        ...
        {
            private static SysInfo.CpuUsage m_CpuUsage = null;
            ...
            public static SysInfo.CpuUsage Create()
            {
                if (m_CpuUsage == null)
                {
                    if (Environment.OSVersion.Platform != PlatformID.Win32NT)
                    {
                        ...
                        m_CpuUsage = new SysInfo.CpuUsage9x();
                    }
                    else
                    {
                        m_CpuUsage = new SysInfo.CpuUsageNt();
                    }
                }
                return m_CpuUsage;
            }
        ...
        internal sealed class CpuUsage9x : SysInfo.CpuUsage
        {
        ...
        internal sealed class CpuUsageNt : SysInfo.CpuUsage
        {
