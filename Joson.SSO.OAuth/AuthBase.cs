...
namespace Joson.SSO.OAuth
{
   ...
   * * */
    ...
    public class BaseClass : System.Web.UI.Page
    {
        ...
        //用于子页面属性设置
        protected BindingFlags BINDING_FLAGS_SET = (BindingFlags.SetProperty | BindingFlags.SetField | BindingFlags.Public | BindingFlags.Instance);
            ...
            else
            {
                ...
                if (Request.QueryString["Token"] != null)
                {
                    ...
                    if (Request.QueryString["Token"] != "$Token$")
                    {
                        ...
                        #region 验证令牌
                        if (JosonValidate.NotIsNullOrEmpty(tokenValue))
                        {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            PropertyInfo[] properties = GetType().GetProperties(BINDING_FLAGS_SET);
