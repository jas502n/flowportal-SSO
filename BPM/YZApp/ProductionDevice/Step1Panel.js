...
YZSoft.Modules.ProductionDevice.Step1Option = {
...
YZSoft.Modules.ProductionDevice.Step1Panel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.store = new YZSoft.Data.JsonStore({
            ...
            proxy: new Ext.data.HttpProxy({
                method: 'GET',
                url: 'YZApp/ProductionDevice/Step1Data.ashx'
            }),
            listeners: {
                scope: this,
                load: function() {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.Modules.ProductionDevice.Step1Option.DeleteProductionDevice(this.grid);
            }
        });
        ...
        var cfg = {
            ...
            layout: 'border',
            items: [this.grid],
            tbar: [this.btnNew, this.btnEdit, this.btnDelete,'|', this.btnExcelExport, '->', {
                xtype: 'button',
                scope: this,
                text: '清除搜索条件',
                handler: function() {
        ...
        YZSoft.Modules.ProductionDevice.Step1Panel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.Modules.ProductionDevice.Step1Panel.superclass.initComponent.call(this);
        this.updateStatus();
    },
    ...
    updateStatus: function() {
        this.btnNew.setDisabled(!YZSoft.UIHelper.IsOptEnable(this, this.grid, ''));
        this.btnEdit.setDisabled(!YZSoft.UIHelper.IsOptEnable(this, this.grid, '', 1, 1));
        this.btnDelete.setDisabled(!YZSoft.UIHelper.IsOptEnable(this, this.grid, '', 1, -1));
