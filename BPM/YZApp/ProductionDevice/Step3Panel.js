...
YZSoft.Modules.ProductionDevice.Step3Option = {
...
YZSoft.Modules.ProductionDevice.Step3Panel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.Modules.ProductionDevice.Step3Option.DeleteProductionDevice(this.grid);
            }
        });
        ...
        var cfg = {
            ...
            layout: 'border',
            items: [this.grid],
            tbar: [this.btnNew, this.btnEdit, this.btnDelete,'|', this.btnExcelExport, '|', this.btnMore, '->', {
                xtype: 'button',
                scope: this,
                text: '清除搜索条件',
                handler: function() {
        ...
        YZSoft.Modules.ProductionDevice.Step3Panel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.Modules.ProductionDevice.Step3Panel.superclass.initComponent.call(this);
        this.updateStatus();
    },
