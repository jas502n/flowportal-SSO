...
YZSoft.Modules.ProductionDevice.Step4Option = {
...
YZSoft.Modules.ProductionDevice.Step4Panel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.store = new YZSoft.Data.JsonStore({
            ...
            proxy: new Ext.data.HttpProxy({
                method: 'GET',
                url: 'YZApp/ProductionDevice/Step234Data.ashx'
            }),
            listeners: {
                scope: this,
                load: function() {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.Modules.ProductionDevice.Step4Option.DeleteProductionDevice(this.grid);
            }
        });
        ...
        YZSoft.Modules.ProductionDevice.Step4Panel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.Modules.ProductionDevice.Step4Panel.superclass.initComponent.call(this);
        this.updateStatus();
    },

    New : function() {
        YZSoft.BPM.FormManager.OpenFormApplication('Demo/ProductionDevice/ProductionDevice', '', 'New', true, {
            title: '添加',
            listeners: {
                scope: this,
                close: function(form) {
    ...
    Edit: function(item) {
        YZSoft.BPM.FormManager.OpenFormApplication('Demo/ProductionDevice/ProductionDevice', item.id, 'Edit', true, {
            title: '修改',
            listeners: {
                scope: this,
                close: function(form) {
    ...
    Read: function(item) {
        YZSoft.BPM.FormManager.OpenFormApplication('Demo/ProductionDevice/ProductionDevice', item.id, 'Read', true, {
            title: '查看'
        });
    },
    ...
    StartRepairProcess: function (item) {
        YZSoft.BPM.FormManager.OpenPostWindow('设备维修', null, {
