...
YZSoft.Modules.ProductionDevice.Step2Option = {
...
YZSoft.Modules.ProductionDevice.Step2Panel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.Modules.ProductionDevice.Step2Option.DeleteProductionDevice(this.grid);
            }
        });
        ...
        YZSoft.Modules.ProductionDevice.Step2Panel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.Modules.ProductionDevice.Step2Panel.superclass.initComponent.call(this);
        this.updateStatus();
    },
