...
YZSoft.PM.ProductionDevice3Option = {
...
YZSoft.PM.ProductionDevice3Panel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.PM.ProductionDevice3Option.DeleteProductionDevice(this.grid);
            }
        });
        ...
        YZSoft.PM.ProductionDevice3Panel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.PM.ProductionDevice3Panel.superclass.initComponent.call(this);
        this.updateStatus();
    },
