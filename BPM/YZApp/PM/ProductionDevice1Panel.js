...
YZSoft.PM.ProductionDevice1Option = {
...
YZSoft.PM.ProductionDevice1Panel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.store = new YZSoft.Data.JsonStore({
            ...
            proxy: new Ext.data.HttpProxy({
                method: 'GET',
                url: 'YZApp/PM/StoreDataService/ProductionDevice1Data.ashx'
            }),
            listeners: {
                scope: this,
                load: function() {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.PM.ProductionDevice1Option.DeleteProductionDevice(this.grid);
            }
        });
        ...
        YZSoft.PM.ProductionDevice1Panel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.PM.ProductionDevice1Panel.superclass.initComponent.call(this);
        this.updateStatus();
    },
