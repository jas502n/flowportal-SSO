...
YZSoft.PM.ProductionDevice2Option = {
...
YZSoft.PM.ProductionDevice2Panel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.PM.ProductionDevice2Option.DeleteProductionDevice(this.grid);
            }
        });
        ...
        YZSoft.PM.ProductionDevice2Panel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.PM.ProductionDevice2Panel.superclass.initComponent.call(this);
        this.updateStatus();
    },
