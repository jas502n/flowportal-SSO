...
YZSoft.PM.ProductionDeviceOption = {
...
YZSoft.PM.ProductionDevicePanel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.btnDelete = new Ext.Button({
            ...
            scope: this,
            handler: function() {
                YZSoft.PM.ProductionDeviceOption.DeleteProductionDevice(this.grid);
            }
        });
        ...
        YZSoft.PM.ProductionDevicePanel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function() {
        YZSoft.PM.ProductionDevicePanel.superclass.initComponent.call(this);
        this.updateStatus();
    },

    //RenderName: function(value, p, record) {
    //    return String.format("<a href='#'onclick=\"YZSoft.BPM.FormManager.OpenFormApplication('PM/Read/ProductionDevice',{0},'Read',true,\{title:'查看设备档案信息-{1}'\})\">{1}</a>",
    //    record.id,
    //    value);
    //},
