...
YZSoft.BPM.Grid.MyTaskCommentGrid_OpenTaskForRead = function (gridid, taskid, sn) {
...
YZSoft.BPM.Grid.MyTaskCommentGrid = Ext.extend(Ext.grid.GridPanel, {
    constructor: function (config) {
        ...
        var cfg = {
            ...
            columns: [
                ...
                { header: "最后讨论时间", dataIndex: 'CreateAt', width: 128, align: 'center', sortable: sortable },//{ header: RS.$('YZStrings.BPM_PostAt'), dataIndex: 'CreateAt', width: 128, align: 'center', sortable: sortable },
                { header: "最新讨论", dataIndex: 'Description', align: 'left', sortable: sortable, id: idDesc }//{ header: RS.$('YZStrings.BPM_TaskDesc'), dataIndex: 'Description', align: 'left', sortable: sortable, id: idDesc }
            ],
        ...
        YZSoft.BPM.Grid.MyTaskCommentGrid.superclass.constructor.call(this, cfg);
    },
    ...
    initComponent: function () {
        ...
        YZSoft.BPM.Grid.MyTaskCommentGrid.superclass.initComponent.call(this);
    },

    RenderSN: function (value, p, record) {
        return String.format("<div><a href='#' onclick=\"YZSoft.BPM.Grid.MyTaskCommentGrid_OpenTaskForRead('{0}',{1},'{2}')\">{3}</a></div>",
            this.id,
            record.data.TaskID,
