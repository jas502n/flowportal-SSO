...
importJS("MyApp/Demo/MyTaskComment/MyTaskCommentGrid.js");
importJS("MyApp/Demo/MyTaskComment/MyTaskCommentStore.js");
...
YZSoft.BPM.MyTaskCommentPanel = Ext.extend(Ext.Panel, {
    constructor: function (config) {
        ...
        this.store = new YZSoft.BPM.Store.MyTaskCommentStore({
            baseParams: { limit: YZSoft.EnvSetting.PageSize.BPM.historyAllAccessable, HistoryTaskType: 'AllAccessable', SpecProcessName: config.SpecProcessName, byYear:0},// config.byYear === false ? 0 : 1 },
            listeners: {
                scope: this,
                beforeload: function () {
