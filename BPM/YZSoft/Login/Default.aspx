...
<head runat="server">
    ...
    <script src="../ExtJS/Scripts/ext-base-debug.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function CheckBrowser(){
	        var browserName, browserPass=false;
	        switch(true){
		        case Ext.isIE:
			        browserPass=true;
			        browserName="IE";
    ...
    <script type="text/javascript">
        function document_loaded(){
            ...
            //document.write("<script src='../ExtJS/Scripts/ext-all-debug.js'><\/script>");
            var oHead = document.getElementsByTagName('HEAD').item(0);
            var oScript= document.createElement("script");
            oScript.type = "text/javascript";
            oScript.src="../ExtJS/Scripts/ext-all-debug.js";
            oHead.appendChild( oScript);
            
            if (!Ext.isIE) { //if not IE
				...
				<div class="login" id="divMainStep" style="display:none;">
					...
					<div class="tip_ie" id="divMainStep0">
						...
						<div id="divIETip" class="ieTip" style="display:none;">
							...
							<a href="###" onclick="return IECheckSwitch(1)" class="getIE"><asp:Literal ID="_litStep0DownloadBrowser" runat="server"></asp:Literal></a>
                        </div>
