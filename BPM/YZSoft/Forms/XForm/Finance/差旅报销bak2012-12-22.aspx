        ...
        <div align="center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-RIGHT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: #d1dedf 1px solid" width="626" bgcolor="#f0f0f0">
                            ...
                            <aspxform:XCompareValidator id="XCompareValidator9" runat="server" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'" Display="None" ErrorMessage="离开日期不能小于出发日期" ControlToValidate="XDateTimePicker8" ValidationGroup="Star" Type="Date" Operator="GreaterThanEqual" ControlToCompare="XDateTimePicker7">离开日期大于开始日期</aspxform:XCompareValidator>
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator21" runat="server" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'" Display="None" ErrorMessage="请选择离开日期！" ControlToValidate="XDateTimePicker8" ValidationGroup="Star">离开日期</aspxform:XRequiredFieldValidator>
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator19" runat="server" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'&amp;&amp;Fin_CE_TE_JW_Info.OverAmount==''" Display="None" ErrorMessage="请填写超标金额汇率" ControlToValidate="XTextBox3" ValidationGroup="Star">汇率</aspxform:XRequiredFieldValidator>
            ...
            <table style="BORDER-RIGHT: medium none; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: medium none" cellspacing="0" cellpadding="0" width="738" border="0">
                <tbody>
                    ...
                    <tr>
                        <td style="BORDER-RIGHT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-LEFT: #d1dedf 1px solid; BORDER-BOTTOM: #d1dedf 1px solid" width="107" height="25">
                            <div align="center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-RIGHT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: #d1dedf 1px solid" width="587">
                            ...
                            <aspxform:XCompareValidator id="XCompareValidator21" runat="server" DisableExpress='Fin_Applicant.PersonalLoan !="是"' Display="None" ErrorMessage="您选择了冲抵个人借款,请填写冲抵金额" ControlToValidate="XTextBox76" ValidationGroup="Star" Height="11px" Type="Double" Operator="GreaterThan" ValueToCompare="0.01">本次冲抵金额</aspxform:XCompareValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="NoPadding" style="BORDER-RIGHT: medium none; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: medium none" valign="bottom" align="left" width="534">
                            <table cellspacing="0" cellpadding="0" border="0" hiddenexpress="Global.StepName =='财务记账'">
                                <tbody>
                                    <tr>
