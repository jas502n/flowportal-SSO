                ...
                <tbody>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="53">
                            <p align="right">
                                <aspxform:XLabel id="XLabel3" runat="server" text="出差原因：" Value ValueToDisplayText></aspxform:XLabel>
                                <aspxform:XLabel id="XLabel4" runat="server" text="出差目的：" HiddenExpress="DigitalHR:HR_GongGan_MAIN.Type!=2" Value ValueToDisplayText></aspxform:XLabel>
                            </p>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" colspan="3">
                            <aspxform:XLabel id="XLabel2" runat="server" text="核高基项目" HiddenExpress="DigitalHR:HR_GongGan_MAIN.Type!=2" Value ValueToDisplayText ForeColor="Red"></aspxform:XLabel>
                            <aspxform:XTextBox id="XTextBox3" runat="server" XDataBind="DigitalHR:HR_GangGan_DTL.Note" BorderColor="#DCDCDC" BorderWidth="1" DisableBehavior="ReadOnly" Width="600px" Height="50px" TextMode="MultiLine"></aspxform:XTextBox>
                            <aspxform:XDropDownList id="hegaoji" runat="server" XDataBind="DigitalHR:HR_GangGan_DTL.Note2" HiddenExpress="DigitalHR:HR_GongGan_MAIN.Type!=2" XDataSource="TableName:HeGaoJi_TravelGoal" DisplayColumn="TravelGoal" ValueColumn="TravelGoal" PromptText="请选择" DisableExpress="DigitalHR:HR_GongGan_MAIN.Type!=2">
                                <asp:ListItem>未绑定</asp:ListItem>
                            </aspxform:XDropDownList>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator4" runat="server" ControlToValidate="XTextBox3" ErrorMessage="请填写出差原因！" Display="None" DisableExpress="DigitalHR:HR_GongGan_MAIN.Type!=2">出差原因</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator8" runat="server" ControlToValidate="hegaoji" ErrorMessage="请选择核高基项目！" Display="None" DisableExpress="DigitalHR:HR_GongGan_MAIN.Type!=2">请选择核高基项目！</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table class="mytable" border="1" cellspacing="0" cellpadding="0" width="801" deletelastrow="Denied" hiddenexpress="DigitalHR:HR_GongGan_MAIN.Type!=2">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" colspan="3">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator9" runat="server" ControlToValidate="chuchaiyuanyin" ErrorMessage="请填写出差原因！" Display="None" DisableExpress="DigitalHR:HR_GongGan_MAIN.Type!=2">出差原因</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
