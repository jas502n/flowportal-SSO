      ...
      protected void Page_Load(object sender, EventArgs e)
        {
           ...
           XTextBox115.Attributes.Add("onpropertychange", "this.style.height=this.scrollHeight+(this.offsetHeight-this.clientHeight+10)");
    ...
    <form runat="server" style="padding-right: 2px; padding-bottom: inherit; padding-left: 55px; padding-top: 2px">
        ...
        <div align="center">
            ...
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="738">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="transparent" height="24" width="108">
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="19" colspan="2">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator26" runat="server" Display="None" ErrorMessage="根据财务差旅费用报销规定，请选择出差申请已批准单据，谢谢!" ControlToValidate="XTextBox113" ValidationGroup="Star">差旅预审批</aspxform:XRequiredFieldValidator>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" bgcolor="#ffffff" height="25" colspan="2" align="middle">
                            ...
                            <aspxform:XTextBox id="XTextBox2" runat="server" XDataBind="Fin_Applicant.Sub_HRID" BorderStyle="Dotted" width="29px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="True" Height="22px"></aspxform:XTextBox>
                            <aspxform:XTextBox id="XTextBox30" runat="server" XDataBind="Fin_ClaimingExpenses.PersonType" BorderStyle="Dotted" width="27px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" Height="22px" HiddenExpress="1"></aspxform:XTextBox>
                            ...
                            <aspxform:XTextBox id="XTextBox74" runat="server" XDataBind="Fin_ClaimingExpenses.PermanentCity" width="29px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" Height="22px" HiddenExpress="1"></aspxform:XTextBox>
                            ...
                            <aspxform:XRangeValidator id="XRangeValidator1" runat="server" Display="None" ErrorMessage="市内交通费不能大于160！" ControlToValidate="XTextBox91" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'" Type="Double" MaximumValue="160" MinimumValue="0">市内交通费</aspxform:XRangeValidator>
                            <aspxform:XRangeValidator id="XRangeValidator2" runat="server" Display="None" ErrorMessage="市内交通费不能大于160！" ControlToValidate="XTextBox53" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'" Type="Double" MaximumValue="160" MinimumValue="0">市内交通费</aspxform:XRangeValidator>
                        </td>
                        <td>
                            <aspxform:XCompareValidator id="XCompareValidator8" runat="server" Display="None" ErrorMessage="行程中住宿费超标了" ControlToValidate="XTextBox94" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.PersonType!='1'&amp;&amp;Fin_ClaimingExpenses.Country=='大陆以外地区'" Type="Double" Operator="LessThanEqual" ValueToCompareExpress="Fin_CE_TE_Info.ZS">住宿费超标验证</aspxform:XCompareValidator>
                        </td>
                        <td>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator9" runat="server" Display="None" ErrorMessage="请填写超标的理由！" ControlToValidate="XTextBox29" ValidationGroup="Star" DisableExpress="Fin_CE_TE_Info.OverAmount==''||Fin_ClaimingExpenses.Country=='大陆以外地区'">超额理由</aspxform:XRequiredFieldValidator>
                            <aspxform:XCompareValidator id="XCompareValidator10" runat="server" Display="None" ErrorMessage="行程终点住宿费超标了！" ControlToValidate="XTextBox100" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.PersonType!='1'&amp;&amp;Fin_ClaimingExpenses.Country=='大陆以外地区'" Type="Double" Operator="LessThanEqual" ValueToCompareExpress="Fin_CE_TE.ZS">住宿费超标验证</aspxform:XCompareValidator>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="20" width="593" align="left">
                            ...
                            <aspxform:XTextBox id="XTextBox112" runat="server" XDataBind="IsFinish" width="22px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1">1</aspxform:XTextBox>
                            <aspxform:XTextBox id="XTextBox116" runat="server" XDataBind="IsType" width="21px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1">1</aspxform:XTextBox>
                            <aspxform:XTextBox id="XTextBox117" runat="server" XDataBind="IsState" width="20px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1">1</aspxform:XTextBox>
                        </td>
            ...
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="738">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="38" width="105">
                            <div align="center">
                                <aspxform:XLabel id="XLabel107" runat="server" text="申请单号" Font-Bold="True"></aspxform:XLabel>
                                <aspxform:XTextBox id="XTextBox119" runat="server" XDataBind="Fin_ChaiLv_YuShenQing.ChaiLv_AppDate" width="5px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1"></aspxform:XTextBox>
                            </div>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="120">
                            <div align="center">
                                ...
                                <aspxform:XTextBox id="XTextBox111" runat="server" XDataBind="Fin_ChaiLv_YuShenQing.ChaiLv_taskid" width="5px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1"></aspxform:XTextBox>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox115" runat="server" XDataBind="Fin_ChaiLv_YuShenQing.ChaiLv_Note" BackColor="#F0F0F0" BorderStyle="None" ReadOnly="True" width="170px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" Height="18px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="18" colspan="7">
                            <aspxform:XLabel id="XLabel8" runat="server" text="差旅各项合计" ForeColor="Black"></aspxform:XLabel>
            ...
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="738" dynamicarea="1,4" hiddenexpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" width="236">
                            <div align="right">
                                <aspxform:XAddBlockButton id="XAddBlockButton3" runat="server" Width="80px" Height="20px" HiddenExpress="Global.StepName!='开始'" Text="添加行程" TableName="Fin_CE_TE_Info" PrintOut="False"></aspxform:XAddBlockButton>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="65" colspan="5">
                            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="100%" hiddenexpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">
                                <tbody>
                                    <tr>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="25" width="68">
                                            <div align="center">
                                                <div align="center">
                                                    <div align="center">
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" rowspan="2" width="132">
                            <div align="center">
                                <aspxform:XLabel id="XLabel3" runat="server" Font-Size="Medium" text="行程终点" ForeColor="Gray"></aspxform:XLabel>
                            </div>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white" width="78">
                            <p align="right">
                                <aspxform:XLabel id="XLabel7" runat="server" text="出发地点" ForeColor="Gray"></aspxform:XLabel>
                                &nbsp;
                            </p>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="236">
                            ...
                            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="100%" hiddenexpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                                            <aspxform:XTextBox id="XTextBox100" runat="server" Font-Bold="False" XDataBind="Fin_CE_TE.Accommodation" width="79px" BorderWidth="1px" BorderColor="Gainsboro" DisableBehavior="ReadOnly" Max="0" Min="0" HiddenInput="False" TextAlign="Right" DisableExpress="Fin_ClaimingExpenses.PersonType=='2'"></aspxform:XTextBox>
                                        ...
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                                            <aspxform:XTextBox id="XTextBox102" runat="server" XDataBind="Fin_CE_TE.BZ" BackColor="#F0F0F0" BorderStyle="None" width="38px" BorderWidth="1" BorderColor="#DCDCDC" HiddenInput="False" Express="if(Fin_ClaimingExpenses.PersonType=='1'||Fin_ClaimingExpenses.PersonType=='4',(javascript('DateDiff',Fin_CE_TE.EndDate,Fin_CE_TE.StarDate)+0.5)*Fin_CE_TE.BZ_per,if(Fin_CE_TE.City_End==Fin_ClaimingExpenses.PermanentCity,(javascript('DateDiff',Fin_CE_TE.EndDate,Fin_CE_TE.StarDate)+0.5)*(Fin_CE_TE.ZS_per+Fin_CE_TE.BZ_per),0))" TextAlign="Right" DisableExpress="Global.StepName !='财务审核'"></aspxform:XTextBox>
                                            <aspxform:XTextBox id="XTextBox46" runat="server" XDataBind="Fin_CE_TE.BZ_per" BorderStyle="Dotted" ReadOnly="True" width="7px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="True" Height="22px"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                                        </td>
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" bgcolor="antiquewhite">
            ...
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="738" dynamicarea="1,5" hiddenexpress="Fin_ClaimingExpenses.Country=='中国大陆'">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" width="238" colspan="2">
                            <div align="right">
                                <div align="right">
                                    <aspxform:XAddBlockButton id="XAddBlockButton2" runat="server" Width="80px" Height="20px" HiddenExpress="Global.StepName!='开始'" Text="添加行程" TableName="Fin_CE_TE_JW_Info" PrintOut="False"></aspxform:XAddBlockButton>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator24" runat="server" Display="None" ErrorMessage="请填写出发国家的城市！" ControlToValidate="XTextBox23" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country!='大陆以外地区'">出发城市</aspxform:XRequiredFieldValidator>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <p align="right">
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator25" runat="server" Display="None" ErrorMessage="请填写出发国家的城市！" ControlToValidate="XTextBox55" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country!='大陆以外地区'">到达城市</aspxform:XRequiredFieldValidator>
                            <aspxform:XCompareValidator id="XCompareValidator22" runat="server" Display="None" ErrorMessage="到达城市不能和出发城市相同！" ControlToValidate="XTextBox55" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country!='大陆以外地区'" Operator="NotEqual" ValueToCompareExpress="Fin_CE_TE_JW_Info.C_Star">城市相同</aspxform:XCompareValidator>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <div align="right">
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="75" colspan="6">
                            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
                                <tbody>
                                    <tr>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="25" colspan="3">
                                            <div align="center">
                                        ...
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="25">
                                            <div align="center">
                                    ...
                                    <tr>
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" height="24" width="47">
                                            ...
                                            <aspxform:XTextBox id="XTextBox22" runat="server" XDataBind="Fin_CE_TE_JW_Info.ZS_Per" BorderStyle="Dotted" width="22px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1"></aspxform:XTextBox>
                                            <aspxform:XTextBox id="XTextBox32" runat="server" XDataBind="Fin_CE_TE_JW_Info.BZ_Per" BorderStyle="Dotted" width="16px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1"></aspxform:XTextBox>
                                        </td>
                                        ...
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="47">
                                            ...
                                            <aspxform:XTextBox id="XTextBox78" runat="server" XDataBind="ZS_Per_Person" BorderStyle="Dotted" width="27px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1" Express='if(Fin_CE_TE_JW_Info.PersonNum =="双人",if(Fin_CE_TE_JW_Info.ZS_Per == 800.00,1200,if(Fin_CE_TE_JW_Info.ZS_Per == 1000.00,1600,if(Fin_CE_TE_JW_Info.ZS_Per == 600.00,1100,0))),Fin_CE_TE_JW_Info.ZS_Per)' Format="type:number;.2"></aspxform:XTextBox>
                                        ...
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="47">
                                            ...
                                            <aspxform:XTextBox id="XTextBox105" runat="server" XDataBind="Fin_CE_TE_JW_Info.ZS" BackColor="#F0F0F0" BorderStyle="None" width="40px" BorderWidth="1" BorderColor="#DCDCDC" HiddenInput="False" HiddenExpress="1" Express="(javascript('DateDiff',Fin_CE_TE_JW_Info.EndDate,Fin_CE_TE_JW_Info.StarDate))*if(Fin_CE_TE_JW_Info.Unit_ZS=='人民币',ZS_Per_Person,ZS_Per_Person/Fin_CE_TE_JW_Info.Rate_ZS)" TextAlign="Right" Format="type:currency;.2"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="92">
                                        ...
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="13">
                                            <aspxform:XTextBox id="XTextBox107" runat="server" XDataBind="Fin_CE_TE_JW_Info.BZ" BackColor="#F0F0F0" BorderStyle="None" ReadOnly="True" width="1px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" Height="22px" HiddenExpress="Fin_CE_TE_JW_Info.ZS_B!=1" Express="(javascript('DateDiff',Fin_CE_TE_JW_Info.EndDate,Fin_CE_TE_JW_Info.StarDate))*Fin_CE_TE_JW_Info.BZ_Per" TextAlign="Right"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="54">
                                            <aspxform:XDropDownList id="XDropDownList7" runat="server" XDataBind="Fin_CE_TE_JW_Info.Unit_BZ" Width="52px" HiddenExpress="Fin_CE_TE_JW_Info.ZS_B==0" XDataSource="TableName:Fin_R_Rate" DataMap="Rate->var8" onchange="javascript:XFormOnChange(this);" Enabled="False" ValueColumn="Unit" DisplayColumn="Unit">
                                        ...
                                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" bgcolor="#f0f0f0" width="41">
                                            <aspxform:XTextBox id="XTextBox108" runat="server" XDataBind="Fin_CE_TE_JW_Info.Rate_BZ" width="39px" BorderWidth="1px" BorderColor="Gainsboro" DisableBehavior="ReadOnly" Max="0" Min="0" HiddenInput="False" HiddenExpress="Fin_CE_TE_JW_Info.ZS_B==0" Express="var8" Format="type:number;.4"></aspxform:XTextBox>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="87">
                                                <aspxform:XTextBox id="XTextBox4" runat="server" XDataBind="Fin_CE_TE_JW_Info.OverAmount" ForeColor="Red" BorderStyle="None" width="82px" BorderWidth="1px" BorderColor="Gainsboro" DisableBehavior="ReadOnly" Max="0" Min="0" HiddenInput="False" TextAlign="Right"></aspxform:XTextBox>
                                            </td>
                                            ...
                                            <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="52">
                                                <div align="left">
                                                    <aspxform:XTextBox id="XTextBox3" runat="server" XDataBind="Fin_CE_TE_JW_Info.Rate_Over" width="45px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" Express="var4" Format="type:number;.4"></aspxform:XTextBox>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" rowspan="2" width="102">
                            <div align="right">
                                <div align="center">
                                    <aspxform:XTextBox id="XTextBox13" runat="server" XDataBind="Fin_CE_TE_JW.Rate" width="21px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="True"></aspxform:XTextBox>
                                    <aspxform:XLabel id="XLabel6" runat="server" Font-Size="Medium" text="行程终点" ForeColor="Gray"></aspxform:XLabel>
                                </div>
                            </div>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="240">
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <aspxform:XDateTimePicker id="XDateTimePicker8" runat="server" XDataBind="Fin_CE_TE_JW.EndDate" Width="120px" BackColor="White" BorderStyle="Groove" BorderWidth="1" BorderColor="#DCDCDC"></aspxform:XDateTimePicker>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <div align="right">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" height="24" width="90">
                                            <aspxform:XTextBox id="XTextBox24" runat="server" XDataBind="Fin_CE_TE_JW.Airfare" BorderStyle="None" width="45px" BorderWidth="1px" BorderColor="Gainsboro" DisableBehavior="ReadOnly" Max="0" Min="0" HiddenInput="False" TextAlign="Right"></aspxform:XTextBox>
                                        ...
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="63">
                                            ...
                                            <aspxform:XTextBox id="XTextBox28" runat="server" XDataBind="var5" width="18px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="True" Format="type:number;.4"></aspxform:XTextBox>
                                        </td>
                                        ...
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="63">
                                            ...
                                            <aspxform:XTextBox id="XTextBox39" runat="server" XDataBind="var6" width="18px" BorderWidth="1px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="True" Format="type:number;.4"></aspxform:XTextBox>
                                        </td>
                                        ...
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="58">
                                            <aspxform:XDropDownList id="XDropDownList11" runat="server" XDataBind="Fin_CE_TE_JW.Unit_BZ" Width="52px" Height="21px" XDataSource="TableName:Fin_R_Rate" DataMap="Rate->var9" onchange="javascript:XFormOnChange(this);" Enabled="False" ValueColumn="Unit" DisplayColumn="Unit">
                                                <asp:ListItem Selected="True">人民币</asp:ListItem>
                                                <asp:ListItem>美元</asp:ListItem>
                                                <asp:ListItem>欧元</asp:ListItem>
                                                <asp:ListItem>港币</asp:ListItem>
            ...
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="738">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="24" width="114">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="113">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="265">
                            <aspxform:XTextBox id="XTextBox26" runat="server" XDataBind="Fin_ClaimingExpenses.DK_Amount" width="100%" BorderWidth="1" BorderColor="#DCDCDC" Express="if(Fin_CE_TE_Total.Total=='',0.00,Fin_CE_TE_Total.Total)-if(Fin_ClaimingExpenses.LoanTotal=='',0.00,Fin_ClaimingExpenses.LoanTotal)" Format="type:currency;.2"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="738" hiddenexpress="Global.StepName!='准备打款'&amp;&amp;Global.StepName!='财务审核'">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="22" width="108">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" width="623">
                            ...
                            <aspxform:XCompareValidator id="XCompareValidator9" runat="server" Display="None" ErrorMessage="离开日期不能小于出发日期" ControlToValidate="XDateTimePicker8" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'" Type="Date" Operator="GreaterThanEqual" ControlToCompare="XDateTimePicker7">离开日期大于开始日期</aspxform:XCompareValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator22" runat="server" Display="None" ErrorMessage="请选择出发日期" ControlToValidate="XDateTimePicker7" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'">出发日期</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator21" runat="server" Display="None" ErrorMessage="请选择离开日期！" ControlToValidate="XDateTimePicker8" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'">离开日期</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator15" runat="server" Display="None" ErrorMessage="请填写机票汇率" ControlToValidate="XTextBox56" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'&amp;&amp;Fin_CE_TE_JW_Info.Airfare==''">汇率</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator16" runat="server" Display="None" ErrorMessage="请填写车船汇率" ControlToValidate="XTextBox103" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'&amp;&amp;Fin_CE_TE_JW_Info.Fare==''">汇率</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator17" runat="server" Display="None" ErrorMessage="请填写住宿费汇率" ControlToValidate="XTextBox106" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'&amp;&amp;Fin_CE_TE_JW_Info.ZS_B==0">汇率</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator18" runat="server" Display="None" ErrorMessage="请填写补助汇率" ControlToValidate="XTextBox108" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'&amp;&amp;Fin_CE_TE_JW_Info.ZS_B==0">汇率</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator19" runat="server" Display="None" ErrorMessage="请填写超标金额汇率" ControlToValidate="XTextBox3" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'&amp;&amp;Fin_CE_TE_JW_Info.OverAmount==''">汇率</aspxform:XRequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator10" runat="server" Display="None" ErrorMessage="请填写超额理由！" ControlToValidate="XTextBox70" ValidationGroup="Star" DisableExpress="Fin_CE_TE_JW_Info.OverAmount==''||Fin_ClaimingExpenses.Country=='中国大陆'">超额理由</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator11" runat="server" Display="None" ErrorMessage="请选择出发日期" ControlToValidate="XDateTimePicker5" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'">出发日期</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator12" runat="server" Display="None" ErrorMessage="请选择离开日期！" ControlToValidate="XDateTimePicker6" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'">离开日期</aspxform:XRequiredFieldValidator>
                            <aspxform:XCompareValidator id="XCompareValidator1" runat="server" Display="None" ErrorMessage="离开日期不能小于出发日期" ControlToValidate="XDateTimePicker6" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'" Operator="GreaterThanEqual" ValueToCompareExpress="Fin_CE_TE_JW_Info.StarDate">离开日期大于开始日期</aspxform:XCompareValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator13" runat="server" Display="None" ErrorMessage="请选择出发地点！" ControlToValidate="XTextBox15" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'">出发地点</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator14" runat="server" Display="None" ErrorMessage="请选择到达地点" ControlToValidate="XTextBox58" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'">到达地点</aspxform:XRequiredFieldValidator>
                            <aspxform:XCompareValidator id="XCompareValidator2" runat="server" Display="None" ErrorMessage="住宿费超标了" ControlToValidate="XTextBox104" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='中国大陆'&amp;&amp;Fin_CE_TE_JW_Info.ZS_B==0" Type="Double" Operator="LessThanEqual" ValueToCompareExpress="Fin_CE_TE_JW_Info.ZS">住宿费超标</aspxform:XCompareValidator>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="transparent" width="84">
                            <div align="center">
                                <div align="center">
                                    <aspxform:XLabel id="XLabel34" runat="server" text="在途审批金额" ForeColor="Gray"></aspxform:XLabel>
                                </div>
                            </div>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="transparent" width="100">
                            <div align="center">
                                <aspxform:XLabel id="XLabel43" runat="server" text="预计还款报销日期" ForeColor="Gray"></aspxform:XLabel>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="transparent">
                            <div align="center">
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <aspxform:XTextBox id="XTextBox40" runat="server" XDataBind="Fin_ClaimingExpenses_LoanInfo.LoanSN" BackColor="White" BorderStyle="None" ReadOnly="True" width="100%" BorderWidth="1" BorderColor="#DCDCDC" DisableBehavior="ReadOnly"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <aspxform:XTextBox id="XTextBox45" runat="server" XDataBind="Fin_ClaimingExpenses_LoanInfo.Reason" BackColor="White" BorderStyle="None" ReadOnly="True" width="100%" BorderWidth="1" BorderColor="#DCDCDC" DisableBehavior="ReadOnly"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <aspxform:XDateTimePicker id="XDateTimePicker9" runat="server" XDataBind="Fin_ClaimingExpenses_LoanInfo.Date" Width="96px" BorderWidth="1" BorderColor="#DCDCDC" DisableExpress="1"></aspxform:XDateTimePicker>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <aspxform:XTextBox id="XTextBox48" runat="server" XDataBind="Fin_ClaimingExpenses_LoanInfo.OffsetAmount" width="100%" BorderWidth="1" BorderColor="#DCDCDC" DisableBehavior="ReadOnly" Format="type:currency;.2"></aspxform:XTextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XTextBox id="XTextBox49" runat="server" XDataBind="Fin_ClaimingExpenses.LoanAmount" BackColor="White" BorderStyle="None" ReadOnly="True" width="100%" BorderWidth="1" BorderColor="#DCDCDC" Express="sum(Fin_ClaimingExpenses_LoanInfo.Remain)"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <aspxform:XTextBox id="XTextBox68" runat="server" XDataBind="Fin_ClaimingExpenses.Amount_Running" BackColor="White" BorderStyle="None" ReadOnly="True" width="100%" BorderWidth="1" BorderColor="#DCDCDC" DisableBehavior="ReadOnly" Express="sum(Fin_ClaimingExpenses_LoanInfo.RunningAmount)"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="white">
                            <div align="center">
                            </div>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none">
                            <aspxform:XTextBox id="XTextBox73" runat="server" XDataBind="qq" width="100%" BorderWidth="1" BorderColor="#DCDCDC" HiddenExpress="1" Express="Fin_ClaimingExpenses.LoanAmount - Fin_ClaimingExpenses.Amount_Running"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                            <div align="right">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="antiquewhite">
                            <aspxform:XTextBox id="XTextBox76" runat="server" XDataBind="Fin_ClaimingExpenses.LoanTotal" BackColor="AntiqueWhite" BorderStyle="None" ReadOnly="True" width="100%" BorderWidth="1" BorderColor="#DCDCDC" DisableBehavior="ReadOnly" Express="sum(Fin_ClaimingExpenses_LoanInfo.OffsetAmount)" Format="type:currency;.2"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="587">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator20" runat="server" Display="None" ErrorMessage="您个人借款明细中有待冲抵的款项，请选择是否冲抵！" ControlToValidate="XRadioButtonList3" ValidationGroup="Star" DisableExpress="qq == 0">请选择是否冲抵个人借款</aspxform:XRequiredFieldValidator>
                            <aspxform:XCompareValidator id="XCompareValidator21" runat="server" Display="None" ErrorMessage="您选择了冲抵个人借款,请填写冲抵金额" ControlToValidate="XTextBox76" ValidationGroup="Star" Height="11px" DisableExpress='Fin_Applicant.PersonalLoan !="是"' Type="Double" Operator="GreaterThan" ValueToCompare="0.01">本次冲抵金额</aspxform:XCompareValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="23" colspan="2">
                            <aspxform:XLabel id="XLabel55" runat="server" text="审批信息" ForeColor="Black" PrintOut="False"></aspxform:XLabel>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: white 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" height="26" valign="bottom" width="200" align="right">
                        ...
                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" class="NoPadding" valign="bottom" width="534" align="left">
                            <table border="0" cellspacing="0" cellpadding="0" hiddenexpress="Global.StepName =='财务记账'">
                                <tbody>
                                    <tr>
                ...
                <tbody>
                    <tr>
                        <td height="25" width="655" align="right">
                            <aspxform:XLabel id="XLabel22" runat="server" text="是否邮件通知提交人" ForeColor="Red"></aspxform:XLabel>
                        </td>
                        <td width="79">
            ...
            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator5" runat="server" Display="None" ErrorMessage="开始时间不能为空！" ControlToValidate="XDateTimePicker4" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">开始时间为空验证</aspxform:XRequiredFieldValidator>
            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator6" runat="server" Display="None" ErrorMessage="结束日期不能为空！" ControlToValidate="XDateTimePicker1" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">结束日期为空验证</aspxform:XRequiredFieldValidator>
            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator7" runat="server" Display="None" ErrorMessage="开始时间不能为空！" ControlToValidate="XDateTimePicker2" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">开始时间为空验证</aspxform:XRequiredFieldValidator>
            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator8" runat="server" Display="None" ErrorMessage="结束日期不能为空！" ControlToValidate="XDateTimePicker3" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">结束日期为空验证</aspxform:XRequiredFieldValidator>
            <aspxform:XCompareValidator id="XCompareValidator3" runat="server" Display="None" ErrorMessage="结束日期不能小于开始日期" ControlToValidate="XDateTimePicker1" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'" Operator="GreaterThanEqual" ValueToCompareExpress="Fin_CE_TE_Info.StarDate">结束日期不能小于开始日期</aspxform:XCompareValidator>
            <aspxform:XCompareValidator id="XCompareValidator4" runat="server" Display="None" ErrorMessage="结束日期不能小于开始日期" ControlToValidate="XDateTimePicker3" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'" Type="Date" Operator="GreaterThanEqual" ControlToCompare="XDateTimePicker2">结束日期大于开始日期</aspxform:XCompareValidator>
            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator3" runat="server" Display="None" ErrorMessage="开始地点不能为空！" ControlToValidate="XTextBox6" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">开始地点验证</aspxform:XRequiredFieldValidator>
            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator4" tabIndex="1" runat="server" Display="None" ErrorMessage="到达地点不能为空！" ControlToValidate="XTextBox10" ValidationGroup="Star" DisableExpress="Fin_ClaimingExpenses.Country=='大陆以外地区'">到达地点验证</aspxform:XRequiredFieldValidator>
            ...
            <aspxform:XRangeValidator id="XRangeValidator7" runat="server" Display="None" ErrorMessage="汇率超出范围了！" ControlToValidate="XTextBox3" ValidationGroup="Star" Type="Double" MaxValueExpress="var4+var4*0.05" MinValueExpress="var4-var4*0.05">汇率</aspxform:XRangeValidator>
            ...
            <aspxform:XCompareValidator id="XCompareValidator16" runat="server" Display="None" ErrorMessage="冲抵金额超出了可冲抵的借款金额！" ControlToValidate="XTextBox48" ValidationGroup="Star" Type="Double" Operator="LessThanEqual" ValueToCompareExpress="varloan">每单冲抵验证</aspxform:XCompareValidator>
            <aspxform:XCompareValidator id="XCompareValidator17" runat="server" Display="None" ErrorMessage="冲抵总额不能大于报销总额！" ControlToValidate="XTextBox76" ValidationGroup="Star" Type="Double" Operator="LessThanEqual" ControlToCompare="XTextBox33">冲抵总额大于报销总额</aspxform:XCompareValidator>
                ...
                <tbody>
                    ...
                    <tr>
                        <td height="136" colspan="3">
                            <p>
                                <aspxform:XLabel id="XLabel57" runat="server" Font-Size="Medium" ForeColor="Red" Text="差旅报销注意事项:" PrintOut="False"></aspxform:XLabel>
                            </p>
                            <p>
                                <aspxform:XLabel id="XLabel60" runat="server" text="1. 提交后请在系统的“历史申请”中将此单打印作为报销单封面附于原始单据前转交至财务部审核。" PrintOut="False"></aspxform:XLabel>
                            </p>
                            <p>
                                <aspxform:XLabel id="XLabel61" runat="server" text="2. “代理人”为此次报销事项的经办人；“申请人”为最终责任人；" PrintOut="False"></aspxform:XLabel>
                            </p>
                            <p>
                                <aspxform:XLabel id="XLabel63" runat="server" text="3. 若“个人借款明细”中的“剩余借款”大于0，请选择“预计还款/报销日期”最早的项目来进行冲抵；" PrintOut="False"></aspxform:XLabel>
                            </p>
                            <p>
                                &nbsp;&nbsp;&nbsp;&nbsp;<aspxform:XLabel id="XLabel71" runat="server" text="在“本次冲抵金额”中填写冲抵金额，此金额应小于或等于本次报销的金额；" PrintOut="False"></aspxform:XLabel>
                            </p>
                            <p>
                                &nbsp;&nbsp;&nbsp;
                                <aspxform:XLabel id="XLabel73" runat="server" text="如不冲抵则无法报销；" PrintOut="False"></aspxform:XLabel>
                            </p>
                        </td>
                    </tr>
                </tbody>
