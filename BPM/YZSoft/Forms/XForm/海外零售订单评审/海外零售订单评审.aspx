...
<body>
    <form runat="server">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" height="58" colspan="3" align="center">
                            <p>
                                <asp:Label id="Label1" runat="server" text="零售海外订单通知书" font-bold="True" font-names="Tahoma" font-size="Medium"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            </p>
                            <p>
                                <aspxform:XLabel id="XLabel68" runat="server" text="翻单注意事项：有更改时请销售助理在填写变更说明时，同时更新正式表单中的内容信息！" Font-Bold="False" HiddenExpress='Global.StepName !="开始"' ForeColor="Red"></aspxform:XLabel>
                            </p>
                        </td>
                    </tr>
                </tbody>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        ...
                        <td width="132">
                            <aspxform:XTextBox id="XTextBox115" runat="server" XDataBind="OFR_HWLS_Applicant.OrderNum" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBox" CssClass="TextBox" NormalCssClass="TextBox" Width="128px"></aspxform:XTextBox>
                        </td>
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_Applicant.OrderType =="新订单"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="204">
                            ...
                            <aspxform:XTextBox id="XTextBox163" runat="server" XDataBind="OFR_HWLS_Applicant.OrderNum_Original" width="70px" Max="0" Min="0" HiddenInput="False" BorderWidth="1px" CssClass="TextBox" BorderColor="Goldenrod"></aspxform:XTextBox>
                            <span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">
                            <aspxform:XDataBrowserButton id="XDataBrowserButton2" runat="server" Width="103px" UseSubmitBehavior="False" PopupWndWidth="800" PopupWndX="100" XDataSource="TableName:V_OFR_HWLS_Applicant;Filter:State->OFR_HWLS_Applicant.State" PopupWndY="100" PopupWndHeight="500" Text="导入原订单信息" DisplayColumns="TaskID:电子流ID;Name:发起人;SN:电子流编号;OrderNum:订单号;DocumentNum:文档编号" DataMap="TaskID->OFR_HWLS_Applicant.TaskID_Original;OrderNum->OFR_HWLS_Applicant.OrderNum_Original"></aspxform:XDataBrowserButton>
                            <aspxform:XTextBox id="XTextBox63" runat="server" XDataBind="OFR_HWLS_Applicant.TaskID_Original" HiddenExpress="1" width="15px" Max="0" Min="0" HiddenInput="False" BorderWidth="1px" CssClass="TextBox" NormalCssClass="TextBox" BorderColor="Goldenrod"></aspxform:XTextBox>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="560">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox46" runat="server" XDataBind="OFR_HWLS_Applicant.ChangeModleRemark" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBox" CssClass="TextBox" NormalCssClass="TextBox" Width="510px" Height="19px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="24" width="945" colspan="3">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator79" runat="server" DisableExpress='OFR_HWLS_Applicant.OrderType == "新订单"' Display="None" ErrorMessage="请勾选变更方式" ControlToValidate="XRadioButtonList47" ValidationGroup="开始">变更方式</aspxform:XRequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                            <aspxform:XTextBox id="XTextBox134" runat="server" XDataBind="OFR_HWLS_Salers.Name" width="428px" Max="0" Min="0" HiddenInput="False" BorderWidth="1px" BorderColor="Gainsboro" BackColor="#F0F0F0" BorderStyle="None" ReadOnly="True"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" colspan="2">
                            <aspxform:XTextBox id="XTextBox135" runat="server" XDataBind="OFR_HWLS_Salers.Dept" width="243px" Max="0" Min="0" HiddenInput="False" BorderWidth="1px" BorderColor="Gainsboro" BackColor="#F0F0F0" BorderStyle="None" ReadOnly="True"></aspxform:XTextBox>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="20" width="998" colspan="2">
                            ...
                            <aspxform:XDropDownList id="XDropDownList1" runat="server" HiddenExpress="1" Width="82px" XDataSource="TableName:V_OFR_HWLS_BInfo;Filter:TaskID->OFR_HWLS_Applicant.TaskID_Original;BufferType:RuntimeUpdate" DataMap="SalesArea->OFR_HWLS_BInfo.SalesArea;BeiSun->OFR_HWLS_BInfo.BeiSun;OrderCategory->OFR_HWLS_BInfo.OrderCategory;GoTheWayGoods_Remark->OFR_HWLS_BInfo.GoTheWayGoods_Remark;ROSH->OFR_HWLS_BInfo.ROSH;CustomerName->OFR_HWLS_BInfo.CustomerName;CentificationRequirements_Other->OFR_HWLS_BInfo.CentificationRequirements_Other;ProductType->OFR_HWLS_BInfo.ProductType;CabinetType_Only->OFR_HWLS_BInfo.CabinetType_Only;PlaceIdentifier_Other->OFR_HWLS_BInfo.PlaceIdentifier_Other;CustomerAddr->OFR_HWLS_BInfo.CustomerAddr;CentificationRequirements->OFR_HWLS_BInfo.CentificationRequirements;ModeOfPayment->OFR_HWLS_BInfo.ModeOfPayment;ProductNameIdentifier_Customer->OFR_HWLS_BInfo.ProductNameIdentifier_Customer;CustomerModel->OFR_HWLS_BInfo.CustomerModel;ThreePatentRequirements_Other->OFR_HWLS_BInfo.ThreePatentRequirements_Other;OtherRequirements->OFR_HWLS_BInfo.OtherRequirements;NewCertificationRequirements_Remark->OFR_HWLS_BInfo.NewCertificationRequirements_Remark;ThreePatent_Reason->OFR_HWLS_BInfo.ThreePatent_Reason;GoTheWayGoods->OFR_HWLS_BInfo.GoTheWayGoods;CustomerBrand->OFR_HWLS_BInfo.CustomerBrand;ModeOfDelivery->OFR_HWLS_BInfo.ModeOfDelivery;CentificationRequirements_Remark->OFR_HWLS_BInfo.CentificationRequirements_Remark;ProductModel->OFR_HWLS_BInfo.ProductModel;CoreNumber->OFR_HWLS_BInfo.CoreNumber;ProductNameIdentifier->OFR_HWLS_BInfo.ProductNameIdentifier;NewCertificationRequirements->OFR_HWLS_BInfo.NewCertificationRequirements;ImportantOrder->OFR_HWLS_BInfo.ImportantOrder;ThreePatentRequirements->OFR_HWLS_BInfo.ThreePatentRequirements;CustomerAbbr->OFR_HWLS_BInfo.CustomerAbbr;SoftRequireImage_Remark->OFR_HWLS_BInfo.SoftRequireImage_Remark;SanJian->OFR_HWLS_BInfo.SanJian;ThreePatent_Remark->OFR_HWLS_BInfo.ThreePatent_Remark;PlaceIdentifier->OFR_HWLS_BInfo.PlaceIdentifier;ModeOfPayment_Remark->OFR_HWLS_BInfo.ModeOfPayment_Remark;ThreePatent->OFR_HWLS_BInfo.ThreePatent;ThreePatentRequirements_Remark->OFR_HWLS_BInfo.ThreePatentRequirements_Remark" onchange="javascript:XFormOnChange(this);" DisplayColumn="TaskID" ValueColumn="TaskID">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="148">
                            <aspxform:XDropDownList id="XDropDownList7" runat="server" XDataBind="OFR_HWLS_BInfo.ProductType" PromptText="请选择">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-TOP: #d1dedf 1px solid" width="213">
                            <aspxform:XTextBox id="XTextBox235" runat="server" XDataBind="OFR_HWLS_BInfo.ProductModel" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBox" CssClass="TextBox" Width="180px"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="80" align="right">
                        ...
                        <td style="BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="325">
                            <aspxform:XTextBox id="XTextBox140" runat="server" XDataBind="OFR_HWLS_BInfo.CustomerAddr" width="181px" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBox" CssClass="TextBox" NormalCssClass="TextBox" Height="23px"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="216">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="213">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator64" runat="server" DisableExpress='OFR_HWLS_BInfo.ProductNameIdentifier !="客户定义"' Display="None" ErrorMessage="请选择产品名称标识!" ControlToValidate="XTextBox5" ValidationGroup="开始">产品名称标识客户</aspxform:XRequiredFieldValidator>
                        </td>
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_HWLS_BInfo.SanJian != 1" dynamicarea="1,1" xdatasource="TableName:OFR_HWLS_BanChengPin;Filter:TaskID->OFR_HWLS_Applicant.TaskID_Original" datamap="Name->OFR_HWLS_BanChengPin.Name;Amount->OFR_HWLS_BanChengPin.Amount;ModuleNumber->OFR_HWLS_BanChengPin.ModuleNumber;Remark->OFR_HWLS_BanChengPin.Remark">
                <tbody>
                    <tr>
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_HWLS_BInfo.BeiSun !=1" dynamicarea="1,1" xdatasource="TableName:OFR_HWLS_SanJian;Filter:TaskID->OFR_HWLS_Applicant.TaskID_Original" datamap="Name->OFR_HWLS_SanJian.Name;Amount->OFR_HWLS_SanJian.Amount;PN->OFR_HWLS_SanJian.PN;Remark->OFR_HWLS_SanJian.Remark">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator47" runat="server" Display="None" ErrorMessage="请选择订金到账！" ControlToValidate="XRadioButtonList21" ValidationGroup="开始">订金到账</aspxform:XRequiredFieldValidator>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="296">
                            <aspxform:XRadioButtonList id="XRadioButtonList53" runat="server" XDataBind="OFR_HWLS_BInfo.GoTheWayGoods" RepeatDirection="Horizontal" ValidationGroup="开始">
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_BInfo.ModeOfDelivery !="分批次出货要求"' dynamicarea="1,1" xdatasource="TableName:OFR_HWLS_Delivery;Filter:TaskID->OFR_HWLS_Applicant.TaskID_Original" datamap="Bath->OFR_HWLS_Delivery.Bath;DeliveryDate->OFR_HWLS_Delivery.DeliveryDate;Amount->OFR_HWLS_Delivery.Amount;CabinetType->OFR_HWLS_Delivery.CabinetType;Remark->OFR_HWLS_Delivery.Remark">
                <tbody>
                    <tr>
        ...
        <div align="center">
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="20" width="850" colspan="2">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator77" runat="server" DisableExpress='OFR_HWLS_BInfo.ThreePatent !="其它"' Display="None" ErrorMessage="您认证选项选择了其他，请填写内容" ControlToValidate="XTextBox37" ValidationGroup="开始">专利选项其他</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator78" runat="server" DisableExpress='OFR_HWLS_BInfo.ThreePatentRequirements  !="其它"' Display="None" ErrorMessage="您要求说明选择了其他，请填写内容" ControlToValidate="XTextBox72" ValidationGroup="开始">专利要求说明其他</aspxform:XRequiredFieldValidator>
                            <font color="red"></font></td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="23" width="51">
                            <aspxform:XLabel id="XLabel117" runat="server" text="认证选项" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="24">
                            <aspxform:XLabel id="XLabel121" runat="server" text="要求说明" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="417">
                            <aspxform:XTextBox id="XTextBox66" runat="server" XDataBind="OFR_HWLS_BInfo.CentificationRequirements_Remark" width="400px" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" rowspan="2" width="93" align="right">
                            <aspxform:XLabel id="XLabel108" runat="server" text="第三方专利要求:"></aspxform:XLabel>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="98">
                            <aspxform:XTextBox id="XTextBox37" runat="server" XDataBind="OFR_HWLS_BInfo.ThreePatent_Remark" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="90px" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="58" align="right">
                            <aspxform:XLabel id="XLabel109" runat="server" text="申请原因:"></aspxform:XLabel>
                        </td>
                        <td width="255">
                            <aspxform:XTextBox id="XTextBox38" runat="server" XDataBind="OFR_HWLS_BInfo.ThreePatent_Reason" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="240px" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XLabel id="XLabel145" runat="server" text="要求说明" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="283">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid" width="390">
                            <aspxform:XTextBox id="XTextBox72" runat="server" XDataBind="OFR_HWLS_BInfo.ThreePatentRequirements_Other" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="358px" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" align="right">
                            <aspxform:XLabel id="XLabel146" runat="server" text="说明:" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XTextBox id="XTextBox105" runat="server" XDataBind="OFR_HWLS_BInfo.ThreePatentRequirements_Remark" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="240px" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" width="930">
                            <aspxform:XDropDownList id="XDropDownList4" runat="server" XDataBind="var1" HiddenExpress="1" XDataSource="TableName:OFR_HWLS_AlternateMachineRequirment;Filter:TaskID->OFR_HWLS_Applicant.TaskID_Original;BufferType:RuntimeUpdate" DisplayColumn="TaskID" ValueColumn="TaskID">
                                <asp:ListItem>未绑定</asp:ListItem>
                            </aspxform:XDropDownList>
                        </td>
                    </tr>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_AlternateMachineRequirment.Type =="" || OFR_HWLS_AlternateMachineRequirment.Type=="研发备机"|| OFR_HWLS_AlternateMachineRequirment.Type=="生产备机"|| OFR_HWLS_AlternateMachineRequirment.Type=="研发备机,生产备机"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="748">
                            <div align="center">
                                <aspxform:XTextBox id="XTextBox13" runat="server" XDataBind="OFR_HWLS_AlternateMachineRequirment.CertificationMachine" ForeColor="Red" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="650px"></aspxform:XTextBox>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="403">
                            <div align="center">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_AlternateMachineRequirment.Type =="" || OFR_HWLS_AlternateMachineRequirment.Type=="认证机器"|| OFR_HWLS_AlternateMachineRequirment.Type=="生产备机"|| OFR_HWLS_AlternateMachineRequirment.Type=="认证机器,生产备机"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="748">
                            <div align="center">
                                <aspxform:XTextBox id="XTextBox7" runat="server" XDataBind="OFR_HWLS_AlternateMachineRequirment.RDMachine" ForeColor="Red" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="650px"></aspxform:XTextBox>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="403">
                            <div align="center">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_AlternateMachineRequirment.Type =="" || OFR_HWLS_AlternateMachineRequirment.Type=="认证机器"|| OFR_HWLS_AlternateMachineRequirment.Type=="研发备机"|| OFR_HWLS_AlternateMachineRequirment.Type=="认证机器,研发备机"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="748">
                            <div align="center">
                                <aspxform:XTextBox id="XTextBox8" runat="server" XDataBind="OFR_HWLS_AlternateMachineRequirment.ProcuctMachine" ForeColor="Red" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" Width="650px"></aspxform:XTextBox>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="403">
                            <div align="center">
        ...
        <div align="center">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_HWLS_PartsRequest.Type_Specification == 0 ">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="90" align="center">
                            <aspxform:XLabel id="XLabel110" runat="server" text="说明书"></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="176">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="192">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox40" runat="server" XDataBind="OFR_HWLS_PartsRequest.Specification_Language" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="176px" Height="24px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="212" align="right">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_HWLS_PartsRequest.Type_Other == 0 ">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="67" align="center">
                            <aspxform:XLabel id="XLabel13" runat="server" text="用量"></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="137">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox16" runat="server" XDataBind="OFR_HWLS_PartsRequest.Other_TieZhi_Use" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="127px" Height="24px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="212">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox39" runat="server" XDataBind="OFR_HWLS_PartsRequest.Other_TieZhi_Position" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" Width="205px" Height="24px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="42" align="center">
        ...
        <div align="center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="1155">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator36" runat="server" Display="None" ErrorMessage="请填写客户化要求中易碎贴纸!" ControlToValidate="XRadioButtonList23" ValidationGroup="开始">易碎贴纸</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator40" runat="server" DisableExpress='OFR_HWLS_CustomerRequirement.TieZhi  !="客户要求"' Display="None" ErrorMessage="请填写客户化要求中的易碎贴纸客户要求!" ControlToValidate="XTextBox44" ValidationGroup="开始">易碎贴纸客户要求</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator23" runat="server" Display="None" ErrorMessage="请选择客户化要求中彩盒!" ControlToValidate="XRadioButtonList27" ValidationGroup="开始">彩盒</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator24" runat="server" DisableExpress='OFR_HWLS_CustomerRequirement.ColorBox !="客户要求"' Display="None" ErrorMessage="请填写客户化要求中彩盒的客户要求!" ControlToValidate="XTextBox191" ValidationGroup="开始">彩盒客户要求</aspxform:XRequiredFieldValidator>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="68" align="center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="235">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox44" runat="server" XDataBind="OFR_HWLS_CustomerRequirement.TieZhi_Remark" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBox" CssClass="TextBox" NormalCssClass="TextBox" Width="202px" Height="20px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_HWLS_CustomerRequirement.CustomerPurchaseMaterial !=1" dynamicarea="1,1" xdatasource="TableName:OFR_HWLS_CR_MyCompany;Filter:ID->OFR_HWLS_Applicant.TaskID_Original" datamap="MaterialName->OFR_HWLS_CR_MyCompany.MaterialName;Amount->OFR_HWLS_CR_MyCompany.Amount;Suppliers->OFR_HWLS_CR_MyCompany.Suppliers;DeliveryTime->OFR_HWLS_CR_MyCompany.DeliveryTime">
                <tbody>
                    <tr>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_HWLS_CustomerRequirement.MyPurchaseMaterial !=1" dynamicarea="1,1" xdatasource="TableName:OFR_HWLS_CR_Customer;Filter:TaskID->OFR_HWLS_Applicant.TaskID_Original" datamap="MaterialName->OFR_HWLS_CR_Customer.MaterialName;Amount->OFR_HWLS_CR_Customer.Amount;Suppliers->OFR_HWLS_CR_Customer.Suppliers;DeliveryTime->OFR_HWLS_CR_Customer.DeliveryTime">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="18" width="35">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="1145">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator62" runat="server" Display="None" ErrorMessage="请上传订单评审参考资料!" ControlToValidate="XMSNAttachments2" ValidationGroup="BOM设计师(BOM比较)">参考资料</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator10" runat="server" DisableExpress="OFR_HWLS_Review_HD.MainYorN  !=1" Display="None" ErrorMessage="请选择主板设计师！" ControlToValidate="XTextBox64" ValidationGroup="产品管理工程师">主板设计师</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator72" runat="server" DisableExpress="OFR_HWLS_Review_HD.PowerYorN  !=1" Display="None" ErrorMessage="请选择电源设计师！" ControlToValidate="XTextBox47" ValidationGroup="产品管理工程师">电源设计师</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="300">
                            ...
                            <aspxform:XCheckBox id="XCheckBox22" runat="server" XDataBind="OFR_HWLS_Review_HD.StructYorN" Text="结构" Checked="True"></aspxform:XCheckBox>
                        ...
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="488">
                            ...
                            <aspxform:XTextBox id="XTextBox48" runat="server" XDataBind="OFR_HWLS_Review_HD.PowerYorN_Designer" HiddenExpress="1" width="25px" Max="0" Min="0" HiddenInput="False" DisableBehavior="ReadOnly" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="1161">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator27" runat="server" Display="None" ErrorMessage="请勾选是否清库存!" ControlToValidate="XRadioButtonList17" ValidationGroup="产品管理工程师">是否清库存</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator28" runat="server" DisableExpress='OFR_HWLS_Review_HD.SemifinishedProducts !="有"' Display="None" ErrorMessage="请填写清库存内容!" ControlToValidate="XTextBox68" ValidationGroup="产品管理工程师">清库存说明</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator48" runat="server" Display="None" ErrorMessage="请勾选是否工艺评审！" ControlToValidate="XRadioButtonList31" ValidationGroup="产品管理工程师">是否工艺评审</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator49" runat="server" DisableExpress='OFR_HWLS_Review_HD.TechnologyReview !="未完成"' Display="None" ErrorMessage="请填写工艺说明内容！" ControlToValidate="XTextBox73" ValidationGroup="工艺签单工程师">工艺评审说明</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator63" runat="server" Display="None" ErrorMessage="请勾选是否完成认证要求！" ControlToValidate="XRadioButtonList26" ValidationGroup="产品管理工程师">认证要求</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator29" runat="server" DisableExpress='OFR_HWLS_Review_HD.OrderConfigType =="A类(翻单)"' Display="None" ErrorMessage="请勾选是否拆单生产!" ControlToValidate="XRadioButtonList30" ValidationGroup="产品管理工程师">拆单生产</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator32" runat="server" DisableExpress='OFR_HWLS_Review_HD.SplitOrder !="是"' Display="None" ErrorMessage="请填写拆单生产说明内容!" ControlToValidate="XTextBox27" ValidationGroup="产品管理工程师">拆单生产说明</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator65" runat="server" DisableExpress='OFR_HWLS_Review_HD.OrderConfigType =="A类(翻单)"' Display="None" ErrorMessage="请选择关键器件是否首次使用!" ControlToValidate="XRadioButtonList10" ValidationGroup="产品管理工程师">DDR</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator66" runat="server" DisableExpress='OFR_HWLS_Review_HD.DDR !="是"' Display="None" ErrorMessage="请填写关键器件首次使用说明内容!" ControlToValidate="XTextBox26" ValidationGroup="产品管理工程师">DDR是</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="106">
                            <aspxform:XRadioButtonList id="XRadioButtonList18" runat="server" XDataBind="OFR_HWLS_Review_HD.SampleMachine" RepeatDirection="Horizontal">
                                <asp:ListItem>无</asp:ListItem>
                                <asp:ListItem>有</asp:ListItem>
                            </aspxform:XRadioButtonList>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="79">
                            <aspxform:XRadioButtonList id="XRadioButtonList10" runat="server" XDataBind="OFR_HWLS_Review_HD.DDR" RepeatDirection="Horizontal">
                                <asp:ListItem>否</asp:ListItem>
                                <asp:ListItem>是</asp:ListItem>
                            </aspxform:XRadioButtonList>
                        </td>
        ...
        <div align="center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="275">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator51" runat="server" Display="None" ErrorMessage="请勾选是否需要样机！" ControlToValidate="XRadioButtonList18" ValidationGroup="产品管理工程师">是否需要样机</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator50" runat="server" Display="None" ErrorMessage="请勾选是否有未封样物料！" ControlToValidate="XRadioButtonList33" ValidationGroup="产品管理工程师">未封样物料</aspxform:XRequiredFieldValidator>
                        </td>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_Review_HD.BOMBPM !="有"' dynamicarea="1,1">
                <tbody>
                    <tr>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_Review_HD.SealedMaterial !="有"' dynamicarea="1,1">
                <tbody>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="122">
                            <aspxform:XLabel id="XLabel115" runat="server" text="说明书软件提供时间：" HiddenExpress='OFR_HWLS_Review_Software.SpecificationChange == "无"'></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="179">
        ...
        <div style="VISIBILITY: visible" align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_Review_Struct.StructSelect == "" || OFR_HWLS_Review_Struct.StructSelect =="增加物料" || OFR_HWLS_Review_Struct.StructSelect =="删除物料" ||OFR_HWLS_Review_Struct.StructSelect =="增加物料,删除物料"' dynamicarea="0,1">
                <tbody>
                    <tr>
        ...
        <div style="VISIBILITY: visible" align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_Review_Struct.StructSelect == "" || OFR_HWLS_Review_Struct.StructSelect =="物料替换" || OFR_HWLS_Review_Struct.StructSelect =="删除物料" ||OFR_HWLS_Review_Struct.StructSelect =="物料替换,删除物料"' dynamicarea="0,1">
                <tbody>
                    <tr>
        ...
        <div style="VISIBILITY: visible" align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_HWLS_Review_Struct.StructSelect == "" || OFR_HWLS_Review_Struct.StructSelect =="物料替换" || OFR_HWLS_Review_Struct.StructSelect =="增加物料" ||OFR_HWLS_Review_Struct.StructSelect =="物料替换,增加物料"' dynamicarea="0,1">
                <tbody>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="1161">
                            <aspxform:XRadioButtonList id="XRadioButtonList19" runat="server" XDataBind="OFR_HWLS_Review_Financial.Approve" RepeatDirection="Horizontal">
                                <asp:ListItem>无需特批</asp:ListItem>
                                <asp:ListItem>需终审人特批</asp:ListItem>
                            </aspxform:XRadioButtonList>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator71" runat="server" Display="None" ErrorMessage="请填写评审意见！" ControlToValidate="XTextBox111" ValidationGroup="财务评审">评审意见</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator70" runat="server" Display="None" ErrorMessage="请选择是否需要特批！" ControlToValidate="XRadioButtonList19" ValidationGroup="财务评审">特批</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
