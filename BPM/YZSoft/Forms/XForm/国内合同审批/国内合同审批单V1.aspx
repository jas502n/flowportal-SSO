                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <p align="left">
                                <aspxform:XTextBox id="XTextBox21" runat="server" Width="420px" DisableBehavior="ReadOnly" XDataBind="GNHT_Applicant_All.Customer" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS"></aspxform:XTextBox>
                                <aspxform:XTextBox id="XTextBox34" runat="server" Width="120px" ReadOnly="True" XDataBind="GNHT_Applicant_All.CustomerID" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS" Express="if(GNHT_Applicant_All.Customer=='','',GNHT_Applicant_All.CustomerID)"></aspxform:XTextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <aspxform:XTextBox id="XTextBox23" runat="server" Width="545px" XDataBind="GNHT_Applicant_All.ContractName" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS"></aspxform:XTextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator152" runat="server" ControlToValidate="XTextBox11" ErrorMessage="请填写合同编号！" Display="None">合同编号</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                    ...
                    <tr hiddenexpress="GNHT_Applicant_All.ContractType!='订货单'">
                        ...
                        <td colspan="3">
                            <aspxform:XTextBox id="XTextBox8" runat="server" Width="545px" ReadOnly="True" XDataBind="GNHT_Applicant_All.FAgreement" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS" Express="if(GNHT_Applicant_All.ContractType!='订货单','','')"></aspxform:XTextBox>
                            <aspxform:XDataBrowserButton id="XDataBrowserButton1" runat="server" Width="21px" DataMap="TaskID->GNHT_Applicant_All.FAgreeTaskID;ContractName->GNHT_Applicant_All.FAgreement" HiddenExpress="Global.StepName!='开始'" XDataSource="TableName:V_GNHT_Contract" DisplayColumns="ContractName:合同(框架协议)名称;Customer:客户名称"></aspxform:XDataBrowserButton>
                            <aspxform:XHistoryFormLink id="XHistoryFormLink1" runat="server" XDataBind="GNHT_Applicant_All.FAgreeTaskID" Express="if(GNHT_Applicant_All.ContractType!='订货单','','')" Text="查看"></aspxform:XHistoryFormLink>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator6" runat="server" ControlToValidate="XTextBox8" ErrorMessage="请填写框架协议！" Display="None" DisableExpress="GNHT_Applicant_All.ContractType!='订货单'">框架协议</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td height="28">
                        ...
                        <td colspan="3">
                            <aspxform:XTextBox id="XTextBox24" runat="server" Width="545px" XDataBind="GNHT_Applicant_All.Signatory" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS"></aspxform:XTextBox>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="99%">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="439">
                                            <aspxform:XTextBox id="XTextBox39" runat="server" Width="318px" XDataBind="GNHT_Applicant_All.Y_CompanyTypeOther" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS" HiddenExpress='GNHT_Applicant_All.Y_CompanyType!="其他"'></aspxform:XTextBox>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <aspxform:XTextBox id="XTextBox22" runat="server" ReadOnly="True" DisableBehavior="ReadOnly" XDataBind="GNHT_Applicant_All.SalesHRName" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS"></aspxform:XTextBox>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="445">
                                            <aspxform:XTextBox id="XTextBox36" runat="server" Width="379px" XDataBind="GNHT_Applicant_All.ClassNote" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS" HiddenExpress="GNHT_Applicant_All.ContractClass!='加急'" BackColor="#FADAFC"></aspxform:XTextBox>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div align="center">
                    ...
                    <tr>
                        <td height="50">
                            <div align="center">
                                ...
                                <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="1" cellspacing="0" cellpadding="0" width="99.5%" align="center" hiddenexpress="GNHT_Applicant_All.ContractType=='代理协议'" deletelastrow="Denied" dynamicarea="1,3">
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td height="23" colspan="7">
                                                付款条件：<aspxform:XTextBox id="XTextBox1" runat="server" Width="390px" ReadOnly="True" XDataBind="GNHT_Applicant_Order.PaymentNote" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS"></aspxform:XTextBox>
                                                <aspxform:XTextBox id="XTextBox31" runat="server" Width="50px" ReadOnly="True" XDataBind="GNHT_Applicant_Order.PaymentNO" CssClass="BOXCSS"></aspxform:XTextBox>
                                        ...
                                        <tr>
                                            <td style="BORDER-BOTTOM: #8080ff 1px solid; BORDER-LEFT: #8080ff 1px solid" height="30" colspan="7">
                                                备&nbsp;&nbsp;&nbsp;&nbsp; 注：<aspxform:XTextBox id="XTextBox32" runat="server" Width="446px" XDataBind="GNHT_Applicant_Order.Remark" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS"></aspxform:XTextBox>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <tr>
                        <td height="48">
                            <p>
                                ...
                                &nbsp;
                                <aspxform:XLabel id="XLabel2" runat="server" text="验收证明：" HiddenExpress="GNHT_Applicant_All.Y_IsDefault!=2"></aspxform:XLabel>
                                <aspxform:XTextBox id="XTextBox40" runat="server" Width="383px" ReadOnly="True" XDataBind="GNHT_Applicant_All.CHKNOTE" Max="0" Min="0" HiddenInput="False" CssClass="BOXCSS" NormalCssClass="BOXCSS" Express="if(GNHT_Applicant_All.ContractType!='订货单','','')" HiddenExpress="GNHT_Applicant_All.Y_IsDefault!=2"></aspxform:XTextBox>
                                <aspxform:XTextBox id="XTextBox41" runat="server" Width="50px" ReadOnly="True" XDataBind="GNHT_Applicant_All.CHKCODE" CssClass="BOXCSS" HiddenExpress="GNHT_Applicant_All.Y_IsDefault!=2"></aspxform:XTextBox>
                            </p>
                            <p>
            ...
            <table class="mytable3" border="1" cellspacing="0" cellpadding="0" width="800">
                <tbody>
                    ...
                    <tr>
                        <td height="35">
                            &nbsp;<a href="../Files/ikan商标证书.pdf" target="_blank">ikan商标证书</a>&nbsp; <a href="../Files/商标证书（动画）.pdf" target="_blank">商标证书（动画）</a>
                        </td>
                    </tr>
                    <tr>
                        <td class="MYHEAD" height="20">
