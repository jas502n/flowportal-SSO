        ...
        <div align="center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="119">
                                <aspxform:XTextBox id="XTextBox11" runat="server" XDataBind="HD_Applicant_Factory.Name" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="22px" width="115px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox"></aspxform:XTextBox>
                            </td>
                            ...
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="166">
                                <aspxform:XTextBox id="XTextBox45" runat="server" XDataBind="HD_Applicant_Factory.ProductMode" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" width="160px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False"></aspxform:XTextBox>
                            </td>
                ...
                <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000">
                    <tbody>
                        <tr>
                            ...
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none" width="501">
            ...
            <div style="VISIBILITY: visible" id="div5">
                ...
                <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000">
                    <tbody>
                        <tr>
                            <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="25" width="1000" colspan="3">
                                <aspxform:XLabel id="XLabel8" runat="server" text="工单更改表格:"></aspxform:XLabel>
                                <aspxform:XTextBox id="XTextBox5" runat="server" XDataBind="HD_Applicant_Factory.FactorySN" width="73px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" BorderWidth="1px"></aspxform:XTextBox>
                        ...
                        <tbody>
                            <tr>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid" height="24" width="346">
                                    ...
                                    <aspxform:XTextBox id="XTextBox25" runat="server" XDataBind="HD_Applicant_Factory.SAP_DNSN" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" Width="125px" BorderWidth="1px" ReadOnly="True">XXX（链接申请表格的编号）</aspxform:XTextBox>
                                    <aspxform:XExcelDataLoadButton id="XExcelDataLoadButton2" runat="server" Text="导入DN数据" ColumnCount="13" DataMap="J->HD_Applicant_FactoryBody_DN.Unit;K->HD_Applicant_FactoryBody_DN.OrderFormState;H->HD_Applicant_FactoryBody_DN.DownNO;I->HD_Applicant_FactoryBody_DN.Num;L->HD_Applicant_FactoryBody_DN.CentralRelation;M->HD_Applicant_FactoryBody_DN.Remark;B->HD_Applicant_FactoryBody_DN.RemoveNO;C->HD_Applicant_FactoryBody_DN.RowProject;F->HD_Applicant_FactoryBody_DN.UpNO;G->HD_Applicant_FactoryBody_DN.ModifyMode;D->HD_Applicant_FactoryBody_DN.FactoryNO;E->HD_Applicant_FactoryBody_DN.FactoryNum"></aspxform:XExcelDataLoadButton>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="560" align="right">
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator10" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XTextBox58" ErrorMessage="请填写销单号！" Display="None">销单号</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator11" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XDropDownList1" ErrorMessage="请选择行项目！" Display="None">行项目</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator12" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XTextBox27" ErrorMessage="请填写工单号！" Display="None"> 工单号</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator13" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XTextBox28" ErrorMessage="请填写工单数量！" Display="None">工单数量</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator14" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XTextBox12" ErrorMessage="请填写上介组件号！" Display="None">上介组件号</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator15" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XDropDownList2" ErrorMessage="请选择修改方式！" Display="None">修改方式</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator16" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XTextBox14" ErrorMessage="请填写下介组件号！" Display="None">下介组件号</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator17" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XTextBox30" ErrorMessage="请填写用量！" Display="None">用量</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator18" runat="server" DisableExpress='if(HD_Applicant_Factory.FactorySN =="",1,if(HD_Applicant_Factory.Check_DN =="否",1,0))' ValidationGroup="工单处理人员" ControlToValidate="XDropDownList3" ErrorMessage="请选择单位！" Display="None">单位</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator4" runat="server" DisableExpress="1" ValidationGroup="录入SAP" ControlToValidate="XTextBox15" ErrorMessage="请输入SAP账号和密码！" Display="None">SAP账号</aspxform:XRequiredFieldValidator>
                    ...
                    <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000" hiddenexpress="HD_Applicant_Factory.FactorySN ==''" dynamicarea="1,1">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox14" onmousemove="showtip(event,this)" onmouseout="hiddentip()" runat="server" XDataBind="HD_Applicant_FactoryBody_DN.DownNO" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="130px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox30" runat="server" XDataBind="HD_Applicant_FactoryBody_DN.Num" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="60px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine" Format="type:number;.4"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="85" colspan="2">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox22" runat="server" XDataBind="HD_Applicant_FactoryBody_DN.Remark" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="75px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                </td>
                            </tr>
                            <tr>
                ...
                <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000">
                    <tbody>
                        <tr>
                            <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="24" width="996">
                                <aspxform:XLabel id="XLabel47" runat="server" text="销单更改表格:"></aspxform:XLabel>
                                <aspxform:XTextBox id="XTextBox9" runat="server" XDataBind="HD_Applicant_Factory.RemoveSN" width="73px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" BorderWidth="1px"></aspxform:XTextBox>
                                <input id="bt2" onclick="Toggle('bt2','div2')" value="隐藏" type="button" />
                                <aspxform:XTextBox id="XTextBox59" runat="server" XDataBind="HD_Applicant_Factory.MessageDN" width="19px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1" BorderWidth="1px" Express="if(HD_Applicant_FactoryBody_DN.FactoryNO=='' ,&quot;&quot;,&quot;工单号已填&quot;)"></aspxform:XTextBox>
                                <aspxform:XTextBox id="XTextBox60" runat="server" XDataBind="HD_Applicant_Factory.MessageECN" width="16px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1" BorderWidth="1px" Express="if(HD_Applicant_FactoryBody_ECN.RemoveNO=='' ,&quot;&quot;,&quot;销单号已填&quot;)"></aspxform:XTextBox>
                                <aspxform:XLabel id="XLabel52" runat="server" text="SAP账号" HiddenExpress="1"></aspxform:XLabel>
                                <aspxform:XTextBox id="XTextBox15" runat="server" XDataBind="HD_Applicant_Factory.SAPAccount" width="76px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1" BorderWidth="1px"></aspxform:XTextBox>
                                <aspxform:XLabel id="XLabel53" runat="server" text="密码" HiddenExpress="1"></aspxform:XLabel>
                                <aspxform:XTextBox id="XTextBox17" runat="server" XDataBind="HD_Applicant_Factory.SAPPassword" width="67px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1" BorderWidth="1px"></aspxform:XTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                    </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid" height="24" width="363">
                                    ...
                                    <aspxform:XTextBox id="XTextBox33" runat="server" XDataBind="HD_Applicant_Factory.SAP_ECNSN" width="115px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" BorderWidth="1px"></aspxform:XTextBox>
                                    <aspxform:XExcelDataLoadButton id="XExcelDataLoadButton1" runat="server" Text="导入ECN数据" ColumnCount="16" DataMap="J->HD_Applicant_FactoryBody_ECN.Digitally_add;K->HD_Applicant_FactoryBody_ECN.QualityState_before;H->HD_Applicant_FactoryBody_ECN.Num;I->HD_Applicant_FactoryBody_ECN.Unit_from;N->HD_Applicant_FactoryBody_ECN.UsePossibility;O->HD_Applicant_FactoryBody_ECN.Remark;L->HD_Applicant_FactoryBody_ECN.QualityState_after;M->HD_Applicant_FactoryBody_ECN.CentralRelation;B->HD_Applicant_FactoryBody_ECN.Biaoshi;C->HD_Applicant_FactoryBody_ECN.RemoveNO;F->HD_Applicant_FactoryBody_ECN.ModifyMode;G->HD_Applicant_FactoryBody_ECN.DownNO;D->HD_Applicant_FactoryBody_ECN.RowProject;E->HD_Applicant_FactoryBody_ECN.UpNO"></aspxform:XExcelDataLoadButton>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="541" align="right">
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator2" runat="server" Width="132px" ValidationGroup="BOM维护员同意" ControlToValidate="XTextBox51" ErrorMessage="请选择设计师" Display="None">BOM维护员选择设计师</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator19" runat="server" DisableExpress='if(HD_Applicant_Factory.RemoveSN =="",1,0)' ValidationGroup="销单录入SAP" ControlToValidate="XTextBox33" ErrorMessage="请填写ECN变更记录号" Display="None">ECN变更记录号</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator20" runat="server" DisableExpress='HD_Applicant_FactoryBody_ECN.ModifyMode !="M"' ValidationGroup="BOM维护员同意" ControlToValidate="XTextBox8" ErrorMessage="修改方式选M时，请填写新下介组件！ " Display="None">新下介组件</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator21" runat="server" DisableExpress="1" ValidationGroup="销单录入SAP" ControlToValidate="XTextBox15" ErrorMessage="请输入SAP账号和密码！" Display="None">SAP账号</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator22" runat="server" DisableExpress='if(HD_Applicant_Factory.RemoveSN =="",1,if(HD_Applicant_Factory.Check_ECN =="否",1,0))' ValidationGroup="BOM维护员同意" ControlToValidate="XTextBox52" ErrorMessage="请填写销单号！" Display="None">销单号</aspxform:XRequiredFieldValidator>
                                    <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator5" runat="server" DisableExpress='if(HD_Applicant_Factory.RemoveSN =="",1,if(HD_Applicant_Factory.Check_ECN =="否",1,0))' ValidationGroup="BOM维护员同意" ControlToValidate="XTextBox39" ErrorMessage="请填写ECN用量！" Display="None">用量</aspxform:XRequiredFieldValidator>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000" hiddenexpress="HD_Applicant_Factory.RemoveSN ==''" dynamicarea="1,1">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox52" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.RemoveNO" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="56px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox36" onmousemove="showtip(event,this)" onmouseout="hiddentip()" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.DownNO" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="147px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox8" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.NewDownNO" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="24px" width="9px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine" HiddenExpress="1" DisableExpress='HD_Applicant_FactoryBody_ECN.ModifyMode !="M"'></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox39" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.Num" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="30px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine" Format="type:number;.6"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox41" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.Digitally_add" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="160px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox43" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.QualityState_before" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="36px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" colspan="3">
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox57" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.CentralRelation" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="35px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox46" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.UsePossibility" DisableCssClass="TextBox" CssClass="TextBox" DisableBehavior="ReadOnly" Height="20px" width="38px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XTextBox id="XTextBox13" onmousemove="showtip(event,this)" onmouseout="hiddentip()" runat="server" XDataBind="HD_Applicant_FactoryBody_ECN.Remark" DisableCssClass="TextBox" CssClass="TextBox" width="100%" BorderColor="#DCDCDC"></aspxform:XTextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none" height="21">
                    ...
                    <tbody>
                        <tr>
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="800" align="middle">
                                <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator8" runat="server" DisableExpress='HD_Applicant_Factory.Test  !="需批量验证"' ValidationGroup="设计师同意" ControlToValidate="XTextBox3" ErrorMessage="验证意见不能为空！" Display="None">验证意见</aspxform:XRequiredFieldValidator>
                ...
                <p>
                    <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000">
                        <tbody>
                            <tr>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="24" width="694" colspan="3">
                                    <aspxform:XLabel id="XLabel41" runat="server" text="设计师:"></aspxform:XLabel>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" width="303">
                                    <div align="right">
                                        <aspxform:XSelectUserButton id="XSelectUserButton1" runat="server" Text="选择设计师" HiddenExpress="Global.StepName!='BOM维护员'" DataMap="Account->HD_Applicant_Designer_Factory.HRID;DisplayName->HD_Applicant_Designer_Factory.Name;MemberFullName->HD_Applicant_Designer_Factory.FullName;Department->HD_Applicant_Designer_Factory.Dept" PopupWndWidth="800" NavigateUrl="~\FormSupport\SelUser.aspx" UseSubmitBehavior="False" PopupWndY="100" PopupWndX="100" PopupWndHeight="500"></aspxform:XSelectUserButton>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="24" width="96">
                                    <div align="center">
                                        <aspxform:XLabel id="XLabel74" runat="server" text="序号"></aspxform:XLabel>
                                    </div>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="590">
                                    <div align="center">
                            ...
                            <tr>
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                                    <aspxform:XTextBox id="XTextBox51" runat="server" XDataBind="HD_Applicant_Designer_Factory.Name" width="428px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" BorderWidth="1px" BorderStyle="None" BackColor="#F0F0F0" ReadOnly="True"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" colspan="2">
                                    <aspxform:XTextBox id="XTextBox54" runat="server" XDataBind="HD_Applicant_Designer_Factory.Dept" width="174px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" BorderWidth="1px" BorderStyle="None" BackColor="#F0F0F0" ReadOnly="True"></aspxform:XTextBox>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="897">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox23" runat="server" XDataBind="HD_Applicant_Factory.SAPError_DN" DisableCssClass="TextBox" CssClass="TextBox" Height="22px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine" Width="866px" ForeColor="Red"></aspxform:XTextBox>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000" hiddenexpress='HD_Applicant_Factory.SAPError_ECN ==""'>
                        <tbody>
                            <tr>
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="909">
                                    <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox24" runat="server" XDataBind="HD_Applicant_Factory.SAPError_ECN" DisableCssClass="TextBox" CssClass="TextBox" Height="22px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" NormalCssClass="TextBox" TextMode="MultiLine" Width="866px" ForeColor="Red"></aspxform:XTextBox>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <p>
                    <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1000" dynamicarea="2,1">
                        <tbody>
                            ...
                            <tr>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="28" width="25">
                                    <div align="center">
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="128">
                                    <div align="center">
                                        <aspxform:XLabel id="XLabel29" runat="server" text="关联模块"></aspxform:XLabel>
                                    </div>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="133">
                                    <div align="center">
                                        <aspxform:XLabel id="XLabel13" runat="server" text="业务组"></aspxform:XLabel>
                                    </div>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="187">
                                    <div align="center">
                                        <aspxform:XLabel id="XLabel31" runat="server" text="关联确认人"></aspxform:XLabel>
                                    </div>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="179" align="middle">
                                    <aspxform:XLabel id="XLabel15" runat="server" text="关联审核人"></aspxform:XLabel>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" valign="center" width="176" align="middle">
                                    <aspxform:XLabel id="XLabel16" runat="server" text="关联批准人"></aspxform:XLabel>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XDropDownList id="XDropDownList4" runat="server" XDataBind="HD_RelationAuditor_Factory.Model" Width="114px" XDataSource="XDataSource" onchange="javascript:XFormOnChange(this);" PromptText="请选择">
                                ...
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XDropDownList id="XDropDownList5" runat="server" XDataBind="HD_RelationAuditor_Factory.BusinessType" Width="123px" XDataSource="TableName:V_HD_RelationAuditor;Filter:Model->HD_RelationAuditor_Factory.Model" onchange="javascript:XFormOnChange(this);" PromptText="请选择" DisplayColumn="BusinessType" ValueColumn="BusinessType">
                                        <asp:ListItem>未绑定</asp:ListItem>
                                    </aspxform:XDropDownList>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XDropDownList id="XDropDownList6" runat="server" XDataBind="HD_RelationAuditor_Factory.ConfirmationName" Width="127px" DataMap="ConfirmationHRID->HD_RelationAuditor_Factory.ConfirmationHRID;AuditName->HD_RelationAuditor_Factory.AuditName;AuditHRID->HD_RelationAuditor_Factory.AuditHRID;ApprovalName->HD_RelationAuditor_Factory.ApprovalName;ApprovalHRID->HD_RelationAuditor_Factory.ApprovalHRID" XDataSource="TableName:HD_RelationAuditor;Filter:Model->HD_RelationAuditor_Factory.Model,BusinessType->HD_RelationAuditor_Factory.BusinessType" onchange="javascript:XFormOnChange(this);" PromptText="请选择" DisplayColumn="ConfirmationName" ValueColumn="ConfirmationName">
                                        <asp:ListItem>未绑定</asp:ListItem>
                                    </aspxform:XDropDownList>
                                    <aspxform:XTextBox id="XTextBox1" runat="server" XDataBind="HD_RelationAuditor_Factory.ConfirmationHRID" width="46px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" BorderWidth="1px"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XDropDownList id="XDropDownList7" runat="server" XDataBind="HD_RelationAuditor_Factory.AuditName" Width="125px" XDataSource="TableName:HD_RelationAuditor;Filter:Model->HD_RelationAuditor_Factory.Model,BusinessType->HD_RelationAuditor_Factory.BusinessType,ConfirmationName->HD_RelationAuditor_Factory.ConfirmationName,ConfirmationHRID->HD_RelationAuditor_Factory.ConfirmationHRID" onchange="javascript:XFormOnChange(this);" PromptText="请选择" DisplayColumn="AuditName" ValueColumn="AuditName">
                                        <asp:ListItem>未绑定</asp:ListItem>
                                    </aspxform:XDropDownList>
                                    <aspxform:XTextBox id="XTextBox6" runat="server" XDataBind="HD_RelationAuditor_Factory.AuditHRID" width="47px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1" BorderWidth="1px"></aspxform:XTextBox>
                                </td>
                                <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                                    <aspxform:XDropDownList id="XDropDownList8" runat="server" XDataBind="HD_RelationAuditor_Factory.ApprovalName" Width="100px" XDataSource="TableName:HD_RelationAuditor;Filter:Model->HD_RelationAuditor_Factory.Model,BusinessType->HD_RelationAuditor_Factory.BusinessType,ConfirmationName->HD_RelationAuditor_Factory.ConfirmationName,ConfirmationHRID->HD_RelationAuditor_Factory.ConfirmationHRID" onchange="javascript:XFormOnChange(this);" PromptText="请选择" DisplayColumn="ApprovalName" ValueColumn="ApprovalName">
                                        <asp:ListItem>未绑定</asp:ListItem>
                                    </aspxform:XDropDownList>
                                    <aspxform:XTextBox id="XTextBox7" runat="server" XDataBind="HD_RelationAuditor_Factory.ApprovalHRID" width="59px" BorderColor="Gainsboro" Max="0" Min="0" HiddenInput="False" HiddenExpress="1" BorderWidth="1px"></aspxform:XTextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <aspxform:XAddBlockButton id="XAddBlockButton3" runat="server" Width="104px" Text="添加关联审核人" HiddenExpress='Global.StepName !="开始" &amp;&amp; Global.StepName !="BOM维护员"&amp;&amp; Global.StepName !="设计师"' UseSubmitBehavior="False" TableName="HD_RelationAuditor_Factory" OnClientClick="XFormShell.XFormAgent.AppendBlock(this,'HD_RelationAuditor_Factory');return false;"></aspxform:XAddBlockButton>
                                </td>
                            </tr>
                        </tbody>
                    </table>
