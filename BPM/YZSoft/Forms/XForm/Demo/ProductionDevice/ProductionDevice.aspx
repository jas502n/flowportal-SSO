...
<body>
    <form id="Form1" runat="server">
        ...
        <p>
            ...
            <aspxform:xrequiredfieldvalidator id="XRequiredFieldValidator2" runat="server" controltovalidate="txtNumber0" errormessage="设备编号不能为空" display="None"></aspxform:xrequiredfieldvalidator>
        </p>
    </form>
</body>
</html>
