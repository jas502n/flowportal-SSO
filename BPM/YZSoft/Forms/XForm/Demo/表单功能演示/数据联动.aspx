    ...
    <form runat="server">
        ...
        <table style="BORDER-RIGHT: medium none; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: medium none" cellspacing="0" cellpadding="0" width="642" border="0">
            <tbody>
                ...
                <tr>
                    <td style="BORDER-RIGHT: #004080 1px solid; BORDER-TOP: medium none; BORDER-LEFT: #004080 2px solid; BORDER-BOTTOM: #004080 1px solid" width="224" height="18">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="BORDER-RIGHT: #004080 2px solid; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: #004080 1px solid" colspan="2">
                        <aspxform:XDropDownList id="XDropDownList7" runat="server" XDataBind="DemoDetailTable8.Str1" Width="100%" ValueColumn="Str1" DisplayColumn="Str1" XDataSource="TableName:DemoDetailTable8" DataMap="Str1->DemoDetailTable2.Str1">
                            <asp:ListItem>未绑定</asp:ListItem>
                        </aspxform:XDropDownList>
                    </td>
                </tr>
                        ...
                        <table style="BORDER-RIGHT: medium none; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: medium none" cellspacing="0" cellpadding="0" width="615" align="center" border="0" dynamicarea="2,1" xdatasource="TableName:DemoDetailTable2;Filter:Str1->DemoDetailTable8.Str1">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="BORDER-TOP: medium none" width="127">
                                        <aspxform:XTextBox id="XTextBox9" runat="server" XDataBind="DemoDetailTable2.Sum2" BorderColor="#DCDCDC" BorderWidth="1" width="100%" Express="sum(DemoDetailTable2.Sum1)"></aspxform:XTextBox>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    ...
                    <td width="150">
                        <aspxform:XTextBox id="XTextBox10" runat="server" XDataBind="DemoDetailTable8.Total1" BorderColor="Gainsboro" BorderWidth="1px" width="100%" Max="0" Min="0" Format=".2" Express="sum(DemoDetailTable2.Sum2)"></aspxform:XTextBox>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <table style="BORDER-RIGHT: medium none; BORDER-TOP: medium none; BORDER-LEFT: medium none; BORDER-BOTTOM: medium none" cellspacing="0" cellpadding="0" width="642" border="0" dynamicarea="1,3" xdatasource="TableName:DemoDetailTable7">
            <tbody>
                <tr>
