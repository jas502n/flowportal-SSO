                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" rowspan="3" width="150">
                            ...
                            &nbsp;</td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" rowspan="3" width="600" align="center">
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" height="22" colspan="2" align="center">
                            <aspxform:XLabel id="XLabel19" runat="server" ValueToDisplayText Value XDataBind="TTC_Applicant.AppSN"></aspxform:XLabel>
                        </td>
                    </tr>
                    <tr>
                        <td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" height="49" width="20%" colspan="4">
                            ...
                            <div align="center">
                                <div align="center">
                                    <aspxform:XLabel id="XLabel13" runat="server" Font-Names="Tahoma" text="第三方许可协议审批单" Font-Size="Medium" Font-Bold="True"></aspxform:XLabel>
                                </div>
                            </div>
                        </td>
                    </tr>
        ...
        <div align="center">
            <table cellspacing="0" cellpadding="0" width="800">
                <tbody>
                    ...
                    <tbody hiddenexpress='TTC_Applicant.ContractType!="海外项目合同"'>
                        <tr>
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="28" width="80">
                            </td>
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                <aspxform:XRadioButtonList id="XRadioButtonList2" runat="server" XDataBind="TTC_Applicant.HWContractType" RepeatDirection="Horizontal">
                                    <asp:ListItem>海外运营</asp:ListItem>
                                    <asp:ListItem>海外零售</asp:ListItem>
                                </aspxform:XRadioButtonList>
                                <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator3" runat="server" ControlToValidate="XRadioButtonList2" ErrorMessage="请选择合同类型" Display="None" DisableExpress='TTC_Applicant.ContractType!="海外项目合同"'>请选择海外合同类型</aspxform:XRequiredFieldValidator>
                            </td>
                        </tr>
                    </tbody>
                    <tbody>
                        <tr>
                            ...
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                <aspxform:XRadioButtonList id="xrdLanguage" runat="server" XDataBind="TTC_Applicant.ContractLanguage" RepeatDirection="Horizontal">
                                    <asp:ListItem>中文合同</asp:ListItem>
                                    <asp:ListItem>英文合同</asp:ListItem>
                                </aspxform:XRadioButtonList>
                                <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator2" runat="server" ControlToValidate="xrdLanguage" ErrorMessage="请选择合同版本" Display="None">请选择合同版本</aspxform:XRequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="28" width="80">
                            ...
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                                <aspxform:XRadioButtonList id="xrdUrgency" runat="server" XDataBind="TTC_Applicant.Urgency" RepeatDirection="Horizontal">
            ...
            <table border="1" cellspacing="0" cellpadding="0" width="800">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="693">
                            <aspxform:XAttachments id="XAttachments1" runat="server" XDataBind="TTC_Applicant.ContractAttachments" width="100%" FileTypesDescription="Word,Excel"></aspxform:XAttachments>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td width="240" align="right">
                                            <aspxform:XPrintButton id="XPrintButton1" runat="server" Width="80px" Height="20px" PageFooterFormat="提交人:________部门负责人:________初审人:________电子流检查:________总裁审批:________" PageHeaderFormat="\t" HiddenExpress="Global.StepName =='开始'"></aspxform:XPrintButton>
                                        </td>
                                        <td>
