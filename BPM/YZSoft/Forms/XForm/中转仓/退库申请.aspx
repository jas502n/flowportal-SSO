                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none">
                            ...
                            <aspxform:XCustomBrowserButton id="XCustomBrowserButton2" runat="server" HiddenExpress="Global.StepName!='开始'&amp;&amp; Global.StepName!='市场支持部(上传审批单)'&amp;&amp; Global.StepName!='市场支持部(建交货号)'" Width="21px" DataMap="Col1->WareHouse_In_CreateInfo_Other.CustomerName;Col2->WareHouse_In_CreateInfo_Other.CustomerNo" PopupWndWidth="600" NavigateUrl="~\FormSupport\SelCustomer.aspx" ColumnCount="2" PrintOut="False"></aspxform:XCustomBrowserButton>
            ...
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='WareHouse_Applicant.InStorageType !="02-其他退回,中转仓入库"' dynamicarea="1,1">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="86">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="36" align="middle">
                            <aspxform:XLabel id="XLabel54" runat="server" text="总裁是否同意" Value ValueToDisplayText Width="37px" Height="28px"></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="62" align="middle">
                            <aspxform:XLabel id="XLabel66" runat="server" text="过账数目" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="116" align="middle">
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="71">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XTextBox id="XTextBox51" runat="server" Value ValueToDisplayText XDataBind="WareHouse_In_CreateInfo_PostInfo.FinanceView" width="120px" Max="0" Min="0" HiddenInput="False" BorderColor="Gainsboro" DisableCssClass="TextBoxPink" NormalCssClass="TextBoxPink" Height="23px" TextMode="MultiLine" CssClass="TextBoxPink"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XDropDownList id="XDropDownList4" runat="server" XDataBind="WareHouse_In_CreateInfo_PostInfo.ApprovalYorN" Width="35px" XDataSource Height="21px" PromptText="选">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" align="middle">
                            <aspxform:XCheckBox id="XCheckBox1" runat="server" XDataBind="WareHouse_In_CreateInfo_PostInfo.PresidentYorN" HiddenExpress='WareHouse_In_CreateInfo_PostInfo.ApprovalYorN !="是"' DisableExpress='WareHouse_In_CreateInfo_PostInfo.ApprovalYorN !="是"' Express="if(varChk=='1',1,'')"></aspxform:XCheckBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                    ...
                    <tr>
                        ...
                        <td width="40">
                            <aspxform:XCheckBox id="XCheckBox7" runat="server" XDataBind="varChk" Text="全选" HiddenExpress='Global.StepName !="总裁办(复审)"' Width="48px"></aspxform:XCheckBox>
                        </td>
                        <td>
                        </td>
                        <td>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="22" width="800" colspan="4">
                            ...
                            <aspxform:XExcelDataLoadButton id="XExcelDataLoadButton1" runat="server" text="主数据信息导入" DataMap="J->WareHouse_In_CreateInfo.OrderNo_Delivery;K->WareHouse_In_CreateInfo.LineItem;H->WareHouse_In_CreateInfo.CreateTime;I->WareHouse_In_CreateInfo.OrderNo;L->WareHouse_In_CreateInfo.Price;B->WareHouse_In_CreateInfo.CustomerName;C->WareHouse_In_CreateInfo.CustomerNo;A->WareHouse_In_CreateInfo.SendOutAddr;F->WareHouse_In_CreateInfo.MachineType;G->WareHouse_In_CreateInfo.Num;D->WareHouse_In_CreateInfo.MachineModel;E->WareHouse_In_CreateInfo.AllMachineNo" ColumnCount="12"></aspxform:XExcelDataLoadButton>
                            </font></span></span></span></td>
                    </tr>
                </tbody>
            </table>
            <table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='WareHouse_Applicant.InStorageType !="01-工厂发货,中转仓入库"' dynamicarea="1,1">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="49" align="middle">
                            <aspxform:XLabel id="XLabel55" runat="server" text="总裁是否同意" Value ValueToDisplayText Width="38px" Height="28px"></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="52" align="middle">
                            <aspxform:XLabel id="XLabel37" runat="server" text="过账数目" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="38" align="middle">
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="56">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                            ...
                            <aspxform:XCustomBrowserButton id="XCustomBrowserButton1" runat="server" HiddenExpress="Global.StepName!='开始'&amp;&amp; Global.StepName!='市场支持部(上传审批单)'&amp;&amp; Global.StepName!='市场支持部(建交货号)'" Width="21px" DataMap="Col1->WareHouse_In_CreateInfo.CustomerName;Col2->WareHouse_In_CreateInfo.CustomerNo" PopupWndWidth="600" NavigateUrl="~\FormSupport\SelCustomer.aspx" ColumnCount="2" PrintOut="False"></aspxform:XCustomBrowserButton>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XDropDownList id="XDropDownList5" runat="server" XDataBind="WareHouse_In_CreateInfo.ApprovalYorN" Width="35px" XDataSource Height="21px" PromptText="选">
                                <asp:ListItem>是</asp:ListItem>
                                <asp:ListItem>否</asp:ListItem>
                            </aspxform:XDropDownList>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" align="middle">
                            <aspxform:XCheckBox id="XCheckBox2" runat="server" XDataBind="WareHouse_In_CreateInfo.PresidentYorN" HiddenExpress='WareHouse_In_CreateInfo.ApprovalYorN !="是"' DisableExpress='WareHouse_In_CreateInfo.ApprovalYorN !="是"' Express="if(varChk1=='1',1,'')"></aspxform:XCheckBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid">
                    ...
                    <tr>
                        ...
                        <td>
                            <aspxform:XCheckBox id="XCheckBox3" runat="server" XDataBind="varChk1" Text="全选" HiddenExpress='Global.StepName !="总裁办(复审)"' Width="48px"></aspxform:XCheckBox>
                        </td>
                        <td>
                        </td>
                        <td>
