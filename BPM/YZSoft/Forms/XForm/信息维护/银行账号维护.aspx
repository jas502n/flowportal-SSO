                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" width="474">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<aspxform:XLabel id="XLabel18" runat="server" Width="359px" Value ValueToDisplayText Font-Bold="True" Font-Size="Medium" text="深圳创维数字技术股份有限公司" Font-Names="Tahoma"></aspxform:XLabel>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="50" colspan="3" align="middle">
                            <div align="center">
                                <aspxform:XLabel id="XLabel14" runat="server" Value ValueToDisplayText Font-Bold="True" Font-Size="Medium" Font-Names="Tahoma" Text="银行账号维护"></aspxform:XLabel>
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="26" colspan="3">
                            ...
                            <aspxform:XLabel id="XLabel24" runat="server" Value ValueToDisplayText Font-Bold="True" text="银行账号"></aspxform:XLabel>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="30" width="274" align="middle">
                                            <aspxform:XLabel id="XLabel21" runat="server" Value ValueToDisplayText Font-Bold="True" text="工号"></aspxform:XLabel>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="30" width="272" align="middle">
                                            <aspxform:XLabel id="XLabel22" runat="server" Value ValueToDisplayText Font-Bold="True" text="姓名"></aspxform:XLabel>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="30" width="188" align="middle">
                                            <aspxform:XLabel id="XLabel26" runat="server" Width="80px" Value ValueToDisplayText Font-Bold="True" text="银行账号"></aspxform:XLabel>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" valign="bottom">
                                            <aspxform:XTextBox id="XTextBox1" runat="server" Width="120px" HiddenInput="False" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Min="0" Max="0" XDataBind="Fin_R_Account_PB.HRID"></aspxform:XTextBox>
                                            <aspxform:XTextBox id="XTextBox4" runat="server" XDataBind="Fin_R_Account_PB.ID" HiddenExpress="1" width="10px" BorderWidth="1" BorderColor="#DCDCDC"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" valign="bottom">
                                            <aspxform:XTextBox id="XTextBox2" runat="server" Width="120px" HiddenInput="False" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Min="0" Max="0" XDataBind="Fin_R_Account_PB.Name"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" valign="bottom">
                                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox3" runat="server" Width="120px" HiddenInput="False" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Min="0" Max="0" XDataBind="Fin_R_Account_PB.Account"></aspxform:XTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
