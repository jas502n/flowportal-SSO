                ...
                <tbody>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="50" colspan="3" align="middle">
                            <div align="center">
                                <aspxform:XLabel id="XLabel14" runat="server" Font-Names="Tahoma" Font-Size="Medium" Font-Bold="True" ValueToDisplayText Value Text="汇率维护"></aspxform:XLabel>
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="26" colspan="3">
                            ...
                            <aspxform:XLabel id="XLabel24" runat="server" text="银行账号" Font-Bold="True" ValueToDisplayText Value></aspxform:XLabel>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="30" width="274" align="middle">
                                            <aspxform:XLabel id="XLabel21" runat="server" text="中文名称" Font-Bold="True" ValueToDisplayText Value></aspxform:XLabel>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="30" width="272" align="middle">
                                            <aspxform:XLabel id="XLabel22" runat="server" text="英文名称" Font-Bold="True" ValueToDisplayText Value></aspxform:XLabel>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="30" width="188" align="middle">
                                            <aspxform:XLabel id="XLabel26" runat="server" text="汇率" Font-Bold="True" ValueToDisplayText Value Width="80px"></aspxform:XLabel>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" valign="bottom">
                                            <aspxform:XTextBox id="XTextBox1" runat="server" Width="120px" XDataBind="Fin_R_Rate.Unit" Max="0" Min="0" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" HiddenInput="False"></aspxform:XTextBox>
                                            <aspxform:XTextBox id="XTextBox4" runat="server" XDataBind="Fin_R_Rate.ID" BorderColor="#DCDCDC" BorderWidth="1" width="10px" HiddenExpress="1"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" valign="bottom">
                                            <aspxform:XTextBox id="XTextBox2" runat="server" Width="120px" XDataBind="Fin_R_Rate.Unit_EN" Max="0" Min="0" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" HiddenInput="False"></aspxform:XTextBox>
                                        </td>
                                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" valign="bottom">
                                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox3" runat="server" Width="120px" XDataBind="Fin_R_Rate.Rate" Max="0" Min="0" DisableCssClass="TextBoxPink" CssClass="TextBoxPink" NormalCssClass="TextBoxPink" HiddenInput="False" Format="type:number;.7"></aspxform:XTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
