...
<body>
    <form runat="server">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" height="58" colspan="3" align="center">
                            <p>
                                <asp:Label id="Label1" runat="server" text="海外运营订单通知书" font-size="Medium" font-names="Tahoma" font-bold="True"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            </p>
                            <p>
                                <aspxform:XLabel id="XLabel68" runat="server" Font-Bold="False" text="翻单注意事项：有更改时请销售助理在填写变更说明时，同时更新正式表单中的内容信息！" ForeColor="Red" HiddenExpress='Global.StepName !="开始"'></aspxform:XLabel>
                            </p>
                        </td>
                    </tr>
                </tbody>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        ...
                        <td width="132">
                            <aspxform:XTextBox id="XTextBox115" runat="server" XDataBind="OFR_WY_Applicant.OrderNum" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="128px" NormalCssClass="TextBox" CssClass="TextBox" DisableCssClass="TextBox"></aspxform:XTextBox>
                        </td>
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_Applicant.OrderType =="新订单"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="214">
                            ...
                            <aspxform:XTextBox id="XTextBox163" runat="server" XDataBind="OFR_WY_Applicant.OrderNum_Original" BorderWidth="1px" HiddenInput="False" Min="0" Max="0" width="70px" CssClass="TextBox" BorderColor="Goldenrod"></aspxform:XTextBox>
                            <span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'"><span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">
                            <aspxform:XDataBrowserButton id="XDataBrowserButton2" runat="server" Width="103px" DisplayColumns="TaskID:电子流ID;Name:发起人;SN:电子流编号;OrderNum:订单号;DocumentNum:文档编号" Text="导入原订单信息" PopupWndHeight="500" PopupWndY="100" XDataSource="TableName:V_OFR_WY_Applicant;Filter:State->OFR_WY_Applicant.State" PopupWndX="100" PopupWndWidth="800" UseSubmitBehavior="False" DataMap="TaskID->OFR_WY_Applicant.TaskID_Original;OrderNum->OFR_WY_Applicant.OrderNum_Original"></aspxform:XDataBrowserButton>
                            <aspxform:XTextBox id="XTextBox63" runat="server" XDataBind="OFR_WY_Applicant.TaskID_Original" HiddenExpress="1" BorderWidth="1px" HiddenInput="False" Min="0" Max="0" width="15px" NormalCssClass="TextBox" CssClass="TextBox" BorderColor="Goldenrod"></aspxform:XTextBox>
                            </span></span></span></span></span></span></span></span></span></span></span></span></span></td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="102" align="right">
                            <aspxform:XLabel id="XLabel84" runat="server" text="变更方式:"></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="288">
                            <span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="551">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox46" runat="server" XDataBind="OFR_WY_Applicant.ChangeModleRemark" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="474px" NormalCssClass="TextBox" CssClass="TextBox" DisableCssClass="TextBox" Height="19px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="1163">
                            <span style="FONT-FAMILY: 宋体; FONT-SIZE: 10.5pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA; mso-bidi-font-family: 'Times New Roman'; mso-font-kerning: 1.0pt; mso-ascii-font-family: 'Times New Roman'; mso-hansi-font-family: 'Times New Roman'">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox4" runat="server" XDataBind="OFR_WY_Applicant.ChangeDescription" ForeColor="Red" HiddenInput="False" Min="0" Max="0" width="100%" DisableBehavior="ReadOnly" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Height="23px" TextMode="MultiLine"></aspxform:XTextBox>
                            </span></td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="24" width="945" colspan="3">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator79" runat="server" ValidationGroup="开始" ControlToValidate="XRadioButtonList47" ErrorMessage="请勾选变更方式" Display="None" DisableExpress='OFR_WY_Applicant.OrderType =="新订单"'>变更方式</aspxform:XRequiredFieldValidator>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" width="302">
                            <div align="right">
                                <aspxform:XSelectUserButton id="XSelectUserButton2" runat="server" Width="85px" Text="选择销售人员" PopupWndHeight="500" PopupWndY="100" PopupWndX="100" PopupWndWidth="800" DataMap="Account->OFR_WY_Salers.HRID;DisplayName->OFR_WY_Salers.Name;MemberFullName->OFR_WY_Salers.FullName;Department->OFR_WY_Salers.Dept" NavigateUrl="~\FormSupport\SelUser.aspx"></aspxform:XSelectUserButton>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0">
                            <aspxform:XTextBox id="XTextBox134" runat="server" XDataBind="OFR_WY_Salers.Name" BorderWidth="1px" HiddenInput="False" Min="0" Max="0" width="428px" BorderColor="Gainsboro" BackColor="#F0F0F0" BorderStyle="None" ReadOnly="True"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#f0f0f0" colspan="2">
                            <aspxform:XTextBox id="XTextBox135" runat="server" XDataBind="OFR_WY_Salers.Dept" BorderWidth="1px" HiddenInput="False" Min="0" Max="0" width="243px" BorderColor="Gainsboro" BackColor="#F0F0F0" BorderStyle="None" ReadOnly="True"></aspxform:XTextBox>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="20" width="998" colspan="2">
                            ...
                            <aspxform:XDropDownList id="XDropDownList1" runat="server" HiddenExpress="1" Width="82px" XDataSource="TableName:V_OFR_WY_BInfo;Filter:TaskID->OFR_WY_Applicant.TaskID_Original;BufferType:RuntimeUpdate" DataMap="CabinetType_Only->OFR_WY_BInfo.CabinetType_Only;PlaceIdentifier_Other->OFR_WY_BInfo.PlaceIdentifier_Other;NewCertificationRequirements_Remark->OFR_WY_BInfo.NewCertificationRequirements_Remark;CustomerAbbr->OFR_WY_BInfo.CustomerAbbr;SanJian->OFR_WY_BInfo.SanJian;BeiSun->OFR_WY_BInfo.BeiSun;CustomerModel->OFR_WY_BInfo.CustomerModel;NewCertificationRequirements->OFR_WY_BInfo.NewCertificationRequirements;CoreNumber->OFR_WY_BInfo.CoreNumber;GoTheWayGoods_Remark->OFR_WY_BInfo.GoTheWayGoods_Remark;CustomerBrand->OFR_WY_BInfo.CustomerBrand;CustomerName->OFR_WY_BInfo.CustomerName;OrderCategory->OFR_WY_BInfo.OrderCategory;ModeOfPayment->OFR_WY_BInfo.ModeOfPayment;OtherRequirements->OFR_WY_BInfo.OtherRequirements;SalesArea->OFR_WY_BInfo.SalesArea;GoTheWayGoods->OFR_WY_BInfo.GoTheWayGoods;ModeOfDelivery->OFR_WY_BInfo.ModeOfDelivery;ImportantOrder->OFR_WY_BInfo.ImportantOrder;ProductModel->OFR_WY_BInfo.ProductModel;ModeOfPayment_Remark->OFR_WY_BInfo.ModeOfPayment_Remark;ROSH->OFR_WY_BInfo.ROSH;ProductType->OFR_WY_BInfo.ProductType;ThreePatent_Remark->OFR_WY_BInfo.ThreePatent_Remark;ProductNameIdentifier_Customer->OFR_WY_BInfo.ProductNameIdentifier_Customer;ThreePatent_Reason->OFR_WY_BInfo.ThreePatent_Reason;SoftRequireImage_Remark->OFR_WY_BInfo.SoftRequireImage_Remark;PlaceIdentifier->OFR_WY_BInfo.PlaceIdentifier;ThreePatent->OFR_WY_BInfo.ThreePatent;CustomerAddr->OFR_WY_BInfo.CustomerAddr;ProductNameIdentifier->OFR_WY_BInfo.ProductNameIdentifier" ValueColumn="TaskID" DisplayColumn="TaskID" onchange="javascript:XFormOnChange(this);">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-TOP: #d1dedf 1px solid" width="213">
                            <aspxform:XTextBox id="XTextBox235" runat="server" XDataBind="OFR_WY_BInfo.ProductModel" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="180px" CssClass="TextBox" DisableCssClass="TextBox"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="80" align="right">
                        ...
                        <td style="BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="325">
                            <aspxform:XTextBox id="XTextBox140" runat="server" XDataBind="OFR_WY_BInfo.CustomerAddr" HiddenInput="False" Min="0" Max="0" width="181px" DisableBehavior="ReadOnly" NormalCssClass="TextBox" CssClass="TextBox" DisableCssClass="TextBox" Height="23px"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="107">
                            <aspxform:XTextBox id="XTextBox31" runat="server" XDataBind="OFR_WY_BInfo.TotalAmount" HiddenInput="False" Min="0" Max="0" width="78px" DisableBehavior="ReadOnly" NormalCssClass="TextBox" CssClass="TextBox" DisableCssClass="TextBox" Express="OFR_WY_BInfo.SalesAmount+OFR_WY_BInfo.SwingAmount"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="213">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator64" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox5" ErrorMessage="请选择产品名称标识!" Display="None" DisableExpress='OFR_WY_BInfo.ProductNameIdentifier !="客户定义"'>产品名称标识客户</aspxform:XRequiredFieldValidator>
                        </td>
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_BInfo.SanJian != 1" dynamicarea="1,1" datamap="Name->OFR_WY_BanChengPin.Name;Amount->OFR_WY_BanChengPin.Amount;ModuleNumber->OFR_WY_BanChengPin.ModuleNumber;Remark->OFR_WY_BanChengPin.Remark" xdatasource="TableName:OFR_WY_BanChengPin;Filter:TaskID->OFR_WY_Applicant.TaskID_Original">
                <tbody>
                    <tr>
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_BInfo.BeiSun !=1" dynamicarea="1,1" datamap="Name->OFR_WY_SanJian.Name;Amount->OFR_WY_SanJian.Amount;PN->OFR_WY_SanJian.PN;Remark->OFR_WY_SanJian.Remark" xdatasource="TableName:OFR_WY_SanJian;Filter:TaskID->OFR_WY_Applicant.TaskID_Original">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator47" runat="server" ValidationGroup="开始" ControlToValidate="XRadioButtonList21" ErrorMessage="请选择订金到账！" Display="None">订金到账</aspxform:XRequiredFieldValidator>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="79" align="right">
                            <aspxform:XLabel id="XLabel69" runat="server" text="订金到账:"></aspxform:XLabel>
                        </td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="296">
                            <aspxform:XRadioButtonList id="XRadioButtonList53" runat="server" XDataBind="OFR_WY_BInfo.GoTheWayGoods" RepeatDirection="Horizontal" ValidationGroup="开始">
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_BInfo.ModeOfDelivery !="分批次出货要求"' dynamicarea="1,1" datamap="Bath->OFR_WY_Delivery.Bath;DeliveryDate->OFR_WY_Delivery.DeliveryDate;Amount->OFR_WY_Delivery.Amount;CabinetType->OFR_WY_Delivery.CabinetType;Remark->OFR_WY_Delivery.Remark" xdatasource="TableName:OFR_WY_Delivery;Filter:TaskID->OFR_WY_Applicant.TaskID_Original">
                <tbody>
                    <tr>
        ...
        <div align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" dynamicarea="0,1" datamap="Remark->OFR_WY_ProductRequirementInfo_Remark.Remark" xdatasource="TableName:OFR_WY_ProductRequirementInfo_Remark;Filter:TaskID->OFR_WY_Applicant.TaskID_Original">
                <tbody>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="20" width="850" colspan="2">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator34" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox72" ErrorMessage="您勾选了第三方专利要求,请填写申请原因" Display="None" DisableExpress='OFR_WY_BInfo.ThreePatent ==""'>申请原因</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator73" runat="server" ValidationGroup="开始" ControlToValidate="XRadioButtonList48" ErrorMessage="您选择了认证选项，请选择要求说明。" Display="None" DisableExpress='OFR_WY_BInfo.NewCertificationRequirements ==""'>认证要求说明</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator74" runat="server" ValidationGroup="开始" ControlToValidate="XRadioButtonList49" ErrorMessage="您选择了专利选项，请选择要求说明。" Display="None" DisableExpress='OFR_WY_BInfo.ThreePatent ==""'>第三方要求说明</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator75" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox118" ErrorMessage="您认证选项选择了其他，请填写内容" Display="None" DisableExpress='OFR_WY_BInfo.NewCertificationRequirements !="其它"'>认证选项其他</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator76" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox119" ErrorMessage="您要求说明选择了其他，请填写内容" Display="None" DisableExpress='OFR_WY_BInfo.CentificationRequirements !="其它"'>认证要求说明其他</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator77" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox71" ErrorMessage="您认证选项选择了其他，请填写内容" Display="None" DisableExpress='OFR_WY_BInfo.ThreePatent !="其它"'>专利选项其他</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator78" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox105" ErrorMessage="您要求说明选择了其他，请填写内容" Display="None" DisableExpress='OFR_WY_BInfo.ThreePatentRequirements  !="其它"'>专利要求说明其他</aspxform:XRequiredFieldValidator>
                            <font color="red"></font></td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" rowspan="2" width="93" align="right">
                            <aspxform:XLabel id="XLabel197" runat="server" text="认证要求:" Width="56px" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="23" width="51">
                            <aspxform:XLabel id="XLabel198" runat="server" text="认证选项" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                    ...
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="24">
                            <aspxform:XLabel id="XLabel199" runat="server" text="要求说明" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="283">
                            <aspxform:XRadioButtonList id="XRadioButtonList48" runat="server" XDataBind="OFR_WY_BInfo.CentificationRequirements" RepeatDirection="Horizontal">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="53" align="right">
                            <aspxform:XLabel id="XLabel200" runat="server" text="说明:" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="51">
                            <aspxform:XLabel id="XLabel144" runat="server" text="专利选项" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" colspan="2">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="98">
                            <aspxform:XTextBox id="XTextBox71" runat="server" XDataBind="OFR_WY_BInfo.ThreePatent_Remark" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="90px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                        ...
                        <td width="255">
                            <aspxform:XTextBox id="XTextBox72" runat="server" XDataBind="OFR_WY_BInfo.ThreePatent_Reason" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="240px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XLabel id="XLabel146" runat="server" text="要求说明" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="283">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid" width="390">
                            <aspxform:XTextBox id="XTextBox105" runat="server" XDataBind="OFR_WY_BInfo.ThreePatentRequirements_Other" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="358px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" align="right">
                            <aspxform:XLabel id="XLabel150" runat="server" text="说明:" Value ValueToDisplayText></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid">
                            <aspxform:XTextBox id="XTextBox106" runat="server" XDataBind="OFR_WY_BInfo.ThreePatentRequirements_Remark" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="240px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" width="930">
                            <aspxform:XDropDownList id="XDropDownList4" runat="server" HiddenExpress="1" XDataSource="TableName:OFR_WY_AlternateMachineRequirment;Filter:TaskID->OFR_WY_Applicant.TaskID_Original;BufferType:RuntimeUpdate" ValueColumn="TaskID" DisplayColumn="TaskID">
                                <asp:ListItem>未绑定</asp:ListItem>
                            </aspxform:XDropDownList>
                        </td>
                    </tr>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_AlternateMachineRequirment.Type =="" || OFR_WY_AlternateMachineRequirment.Type=="研发备机"|| OFR_WY_AlternateMachineRequirment.Type=="生产备机"|| OFR_WY_AlternateMachineRequirment.Type=="研发备机,生产备机"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="748">
                            <div align="center">
                                <aspxform:XTextBox id="XTextBox13" runat="server" XDataBind="OFR_WY_AlternateMachineRequirment.CertificationMachine" ForeColor="Red" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="650px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink"></aspxform:XTextBox>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="403">
                            <div align="center">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_AlternateMachineRequirment.Type =="" || OFR_WY_AlternateMachineRequirment.Type=="认证机器"|| OFR_WY_AlternateMachineRequirment.Type=="生产备机"|| OFR_WY_AlternateMachineRequirment.Type=="认证机器,生产备机"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="748">
                            <div align="center">
                                <aspxform:XTextBox id="XTextBox7" runat="server" XDataBind="OFR_WY_AlternateMachineRequirment.RDMachine" ForeColor="Red" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="650px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink"></aspxform:XTextBox>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="403">
                            <div align="center">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_AlternateMachineRequirment.Type =="" || OFR_WY_AlternateMachineRequirment.Type=="认证机器"|| OFR_WY_AlternateMachineRequirment.Type=="研发备机"|| OFR_WY_AlternateMachineRequirment.Type=="认证机器,研发备机"'>
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="748">
                            <div align="center">
                                <aspxform:XTextBox id="XTextBox8" runat="server" XDataBind="OFR_WY_AlternateMachineRequirment.ProcuctMachine" ForeColor="Red" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="650px" CssClass="TextBoxPink" DisableCssClass="TextBoxPink"></aspxform:XTextBox>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="403">
                            <div align="center">
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" bgcolor="#d1dedf" height="20" width="850" colspan="2">
                            ...
                            <font color="red">
                            <aspxform:XDropDownList id="XDropDownList3" runat="server" HiddenExpress="1" Width="75px" XDataSource="TableName:OFR_WY_PartsRequest;Filter:TaskID->OFR_WY_Applicant.TaskID_Original;BufferType:RuntimeUpdate" DataMap="Battery->OFR_WY_PartsRequest.Battery;Specification_Other->OFR_WY_PartsRequest.Specification_Other;AVCable->OFR_WY_PartsRequest.AVCable;OtherCable->OFR_WY_PartsRequest.OtherCable;HDMICable->OFR_WY_PartsRequest.HDMICable;Other_WarrantyCard->OFR_WY_PartsRequest.Other_WarrantyCard;Other_SinglePage->OFR_WY_PartsRequest.Other_SinglePage;YPbPrCable_Remark->OFR_WY_PartsRequest.YPbPrCable_Remark;Specification_Language->OFR_WY_PartsRequest.Specification_Language;Type_SCART->OFR_WY_PartsRequest.Type_SCART;YPbPrCable->OFR_WY_PartsRequest.YPbPrCable;Battery_Remark->OFR_WY_PartsRequest.Battery_Remark;RemoteControl_Purchase->OFR_WY_PartsRequest.RemoteControl_Purchase;RemoteControl_PurchaseRemark->OFR_WY_PartsRequest.RemoteControl_PurchaseRemark;Type_YPbPr->OFR_WY_PartsRequest.Type_YPbPr;Type_AV->OFR_WY_PartsRequest.Type_AV;Other_TieZhi_Use->OFR_WY_PartsRequest.Other_TieZhi_Use;AVCable_Remark->OFR_WY_PartsRequest.AVCable_Remark;RemoteControl_PurchaseAppoint->OFR_WY_PartsRequest.RemoteControl_PurchaseAppoint;Other_Remark->OFR_WY_PartsRequest.Other_Remark;Other_TieZhi->OFR_WY_PartsRequest.Other_TieZhi;SCARTCable_Remark->OFR_WY_PartsRequest.SCARTCable_Remark;Type_HDMI->OFR_WY_PartsRequest.Type_HDMI;Specification_OtherRemark->OFR_WY_PartsRequest.Specification_OtherRemark;Type_YKQ->OFR_WY_PartsRequest.Type_YKQ;Type_Other->OFR_WY_PartsRequest.Type_Other;Other_TieZhi_Position->OFR_WY_PartsRequest.Other_TieZhi_Position;SCARTCable->OFR_WY_PartsRequest.SCARTCable;Type_Specification->OFR_WY_PartsRequest.Type_Specification;OtherCable_Remark->OFR_WY_PartsRequest.OtherCable_Remark;HDMICable_Remark->OFR_WY_PartsRequest.HDMICable_Remark;Type_Otherline->OFR_WY_PartsRequest.Type_Otherline;Type_Battery->OFR_WY_PartsRequest.Type_Battery" ValueColumn="TaskID" DisplayColumn="TaskID" onchange="javascript:XFormOnChange(this);">
                                <asp:ListItem>未绑定</asp:ListItem>
                            </aspxform:XDropDownList>
                            <aspxform:XDropDownList id="XDropDownList5" runat="server" HiddenExpress="1" XDataSource="TableName:OFR_WY_CustomerRequirement;Filter:TaskID->OFR_WY_Applicant.TaskID_Original;BufferType:RuntimeUpdate" DataMap="SurfaceShellSilk->OFR_WY_CustomerRequirement.SurfaceShellSilk;TieZhi->OFR_WY_CustomerRequirement.TieZhi;CustomerPurchaseMaterial->OFR_WY_CustomerRequirement.CustomerPurchaseMaterial;UppeCover_Remark->OFR_WY_CustomerRequirement.UppeCover_Remark;ColorBox_Remark->OFR_WY_CustomerRequirement.ColorBox_Remark;Color->OFR_WY_CustomerRequirement.Color;TieZhi_Remark->OFR_WY_CustomerRequirement.TieZhi_Remark;BackSilk->OFR_WY_CustomerRequirement.BackSilk;SurfaceShellSilk_Remark->OFR_WY_CustomerRequirement.SurfaceShellSilk_Remark;Carton->OFR_WY_CustomerRequirement.Carton;ColorBox->OFR_WY_CustomerRequirement.ColorBox;Carton_Remark->OFR_WY_CustomerRequirement.Carton_Remark;ColorButton->OFR_WY_CustomerRequirement.ColorButton;Other->OFR_WY_CustomerRequirement.Other;BackSilk_Remark->OFR_WY_CustomerRequirement.BackSilk_Remark;Color_Remark->OFR_WY_CustomerRequirement.Color_Remark;MyPurchaseMaterial->OFR_WY_CustomerRequirement.MyPurchaseMaterial;UppeCover->OFR_WY_CustomerRequirement.UppeCover;ColorButton_Remark->OFR_WY_CustomerRequirement.ColorButton_Remark" ValueColumn="TaskID" DisplayColumn="TaskID">
                                <asp:ListItem>未绑定</asp:ListItem>
                            </aspxform:XDropDownList>
                            <aspxform:XDropDownList id="XDropDownList6" runat="server" HiddenExpress="1" XDataSource="TableName:OFR_WY_SerialNumberRequirement;Filter:TaskID->OFR_WY_Applicant.TaskID_Original;BufferType:RuntimeUpdate" DataMap="Remark->OFR_WY_SerialNumberRequirement.Remark;Type_SerialNumber->OFR_WY_SerialNumberRequirement.Type_SerialNumber;SerialNumber_PasteMethod->OFR_WY_SerialNumberRequirement.SerialNumber_PasteMethod;Type_Other->OFR_WY_SerialNumberRequirement.Type_Other;SerialNumber_PasteMethodRemark->OFR_WY_SerialNumberRequirement.SerialNumber_PasteMethodRemark;SerialNumber_StickerRemark->OFR_WY_SerialNumberRequirement.SerialNumber_StickerRemark;Other->OFR_WY_SerialNumberRequirement.Other;MACAdd_StickerRemark->OFR_WY_SerialNumberRequirement.MACAdd_StickerRemark;SerialNumber_Sticker->OFR_WY_SerialNumberRequirement.SerialNumber_Sticker;MACAdd_PasteMethod->OFR_WY_SerialNumberRequirement.MACAdd_PasteMethod;MACAdd_Sticker->OFR_WY_SerialNumberRequirement.MACAdd_Sticker;MACAdd_PasteMethodRemark->OFR_WY_SerialNumberRequirement.MACAdd_PasteMethodRemark;Type_MAC->OFR_WY_SerialNumberRequirement.Type_MAC" ValueColumn="TaskID" DisplayColumn="TaskID">
                                <asp:ListItem>未绑定</asp:ListItem>
                            </aspxform:XDropDownList>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator35" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox40" ErrorMessage="您勾选了说明书,请填写说明书语言" Display="None" DisableExpress="OFR_WY_PartsRequest.Type_Specification == 0 ">说明书语言</aspxform:XRequiredFieldValidator>
                            </font></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_PartsRequest.Type_YKQ  == 0 ">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="245">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_PartsRequest.Type_Battery == 0 ">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="246">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="906">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_PartsRequest.Type_Specification == 0 ">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="124" align="right">
                            <aspxform:XLabel id="XLabel111" runat="server" text="说明书语言"></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="228">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox40" runat="server" XDataBind="OFR_WY_PartsRequest.Specification_Language" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="197px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Height="24px" TextMode="MultiLine" Value ValueToDisplayText></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="177" align="right">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="494">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_PartsRequest.Type_Other == 0 ">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="55">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="138">
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="212">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox39" runat="server" XDataBind="OFR_WY_PartsRequest.Other_TieZhi_Position" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="205px" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink" Height="24px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="42">
                            <aspxform:XLabel id="XLabel67" runat="server" text="备注"></aspxform:XLabel>
                        </td>
        ...
        <div align="center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="1155">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator18" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox81" ErrorMessage="请填写客户化要求中的面壳颜色!" Display="None" DisableExpress='OFR_WY_CustomerRequirement.Color !="其它"'>面壳颜色其他</aspxform:XRequiredFieldValidator>
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator20" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox193" ErrorMessage="请填写客户化要求中的面壳丝印!" Display="None" DisableExpress='OFR_WY_CustomerRequirement.SurfaceShellSilk !="客户要求"'>面壳丝印客户要求</aspxform:XRequiredFieldValidator>
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator22" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox123" ErrorMessage="请填写客户化要求中的背板丝印客户要求!" Display="None" DisableExpress='OFR_WY_CustomerRequirement.BackSilk !="客户要求"'>背板丝印客户要求</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator36" runat="server" ValidationGroup="开始" ControlToValidate="XRadioButtonList23" ErrorMessage="请填写客户化要求中易碎贴纸!" Display="None">易碎贴纸</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator40" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox44" ErrorMessage="请填写客户化要求中的易碎贴纸客户要求!" Display="None" DisableExpress='OFR_WY_CustomerRequirement.TieZhi  !="客户要求"'>易碎贴纸客户要求</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator23" runat="server" ValidationGroup="开始" ControlToValidate="XRadioButtonList27" ErrorMessage="请选择客户化要求中彩盒!" Display="None">彩盒</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator24" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox191" ErrorMessage="请填写客户化要求中彩盒的客户要求!" Display="None" DisableExpress='OFR_WY_CustomerRequirement.ColorBox !="客户要求"'>彩盒客户要求</aspxform:XRequiredFieldValidator>
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator61" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox192" ErrorMessage="请填写客户化要求中彩盒的客户要求!" Display="None" DisableExpress='OFR_WY_CustomerRequirement.Carton !="客户要求"'>外箱客户要求</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator67" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox42" ErrorMessage="请选择了客户化要求中按键为特殊,请填写内容!" Display="None" DisableExpress='OFR_WY_CustomerRequirement.ColorButton !="特殊"'>按键特殊</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator68" runat="server" ValidationGroup="开始" ControlToValidate="XTextBox43" ErrorMessage="请填写上盖工艺的客户要求！" Display="None" DisableExpress='OFR_WY_CustomerRequirement.UppeCover !="客户要求"'>上盖工艺客户要求</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250">
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="124">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="235">
                            <aspxform:XTextBox style="OVERFLOW: hidden" id="XTextBox44" runat="server" XDataBind="OFR_WY_CustomerRequirement.TieZhi_Remark" HiddenInput="False" Min="0" Max="0" DisableBehavior="ReadOnly" Width="95px" NormalCssClass="TextBox" CssClass="TextBox" DisableCssClass="TextBox" Height="20px" TextMode="MultiLine"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_CustomerRequirement.CustomerPurchaseMaterial !=1" dynamicarea="1,1" datamap="MaterialName->OFR_WY_CR_MyCompany.MaterialName;Amount->OFR_WY_CR_MyCompany.Amount;Suppliers->OFR_WY_CR_MyCompany.Suppliers;DeliveryTime->OFR_WY_CR_MyCompany.DeliveryTime" xdatasource="TableName:OFR_WY_CR_MyCompany;Filter:ID->OFR_WY_Applicant.TaskID_Original">
                <tbody>
                    <tr>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress="OFR_WY_CustomerRequirement.MyPurchaseMaterial !=1" dynamicarea="1,1" datamap="MaterialName->OFR_WY_CR_Customer.MaterialName;Amount->OFR_WY_CR_Customer.Amount;Suppliers->OFR_WY_CR_Customer.Suppliers;DeliveryTime->OFR_WY_CR_Customer.DeliveryTime" xdatasource="TableName:OFR_WY_CR_Customer;Filter:TaskID->OFR_WY_Applicant.TaskID_Original">
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" height="18" width="35">
                    ...
                    <tbody>
                        <tr>
                            <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="27" width="94" align="center">
                                <aspxform:XLabel id="XLabel82" runat="server" text="软件特性说明"></aspxform:XLabel>
                            </td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="1145">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator62" runat="server" ValidationGroup="BOM设计师(BOM比较)" ControlToValidate="XMSNAttachments2" ErrorMessage="请上传订单评审参考资料!" Display="None">参考资料</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator10" runat="server" ValidationGroup="产品管理工程师" ControlToValidate="XTextBox64" ErrorMessage="请选择主板设计师！" Display="None" DisableExpress="OFR_WY_Review_HD.MainYorN  !=1">主板设计师</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator72" runat="server" ValidationGroup="产品管理工程师" ControlToValidate="XTextBox47" ErrorMessage="请选择电源设计师！" Display="None" DisableExpress="OFR_WY_Review_HD.PowerYorN  !=1">电源设计师</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="300">
                            ...
                            <aspxform:XCheckBox id="XCheckBox22" runat="server" XDataBind="OFR_WY_Review_HD.StructYorN" Text="结构" Checked="True"></aspxform:XCheckBox>
                        ...
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="54">
                            <aspxform:XSelectUserButton id="XSelectUserButton3" runat="server" HiddenExpress="OFR_WY_Review_HD.MainYorN  !=1" Width="22px" Height="20px" Text="..." PopupWndHeight="500" PopupWndY="100" PopupWndX="100" PopupWndWidth="800" UseSubmitBehavior="False" DataMap="Account->OFR_WY_Review_HD.MainYorN_Designer;DisplayName->OFR_WY_Review_HD.MainYorN_DesignerName" NavigateUrl="~\FormSupport\SelUser.aspx"></aspxform:XSelectUserButton>
                        ...
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="68">
                            <aspxform:XLabel id="XLabel116" runat="server" text="电源设计师:" HiddenExpress="OFR_WY_Review_HD.PowerYorN  !=1"></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="82">
                            <aspxform:XTextBox id="XTextBox47" runat="server" XDataBind="OFR_WY_Review_HD.PowerYorN_DesignerName" HiddenExpress="OFR_WY_Review_HD.PowerYorN  !=1" HiddenInput="False" Min="0" Max="0" width="77px" DisableBehavior="ReadOnly" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink"></aspxform:XTextBox>
                        </td>
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="488">
                            ...
                            <aspxform:XTextBox id="XTextBox48" runat="server" XDataBind="OFR_WY_Review_HD.PowerYorN_Designer" HiddenExpress="1" HiddenInput="False" Min="0" Max="0" width="25px" DisableBehavior="ReadOnly" NormalCssClass="TextBoxPink" CssClass="TextBoxPink" DisableCssClass="TextBoxPink"></aspxform:XTextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="1161">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator28" runat="server" ValidationGroup="产品管理工程师" ControlToValidate="XTextBox68" ErrorMessage="您选择清库存为有,请填写内容!" Display="None" DisableExpress='OFR_WY_Review_HD.SemifinishedProducts !="有"'>清半成品库存有</aspxform:XRequiredFieldValidator>
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator49" runat="server" ValidationGroup="工艺签单工程师" ControlToValidate="XTextBox73" ErrorMessage="产品管理工程师选择了工艺评审中的未完成，请填写内容！" Display="None" DisableExpress='OFR_WY_Review_HD.TechnologyReview !="未完成"'>工艺评审未完成</aspxform:XRequiredFieldValidator>
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator29" runat="server" ValidationGroup="产品管理工程师" ControlToValidate="XRadioButtonList30" ErrorMessage="请选择拆单生产!" Display="None" DisableExpress='OFR_WY_Review_HD.OrderConfigType =="A类(翻单)"'>拆单生产</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator32" runat="server" ValidationGroup="产品管理工程师" ControlToValidate="XTextBox27" ErrorMessage="您选择拆单生产为是,请填写内容!" Display="None" DisableExpress='OFR_WY_Review_HD.SplitOrder !="是"'>拆单生产是</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator65" runat="server" ValidationGroup="产品管理工程师" ControlToValidate="XRadioButtonList10" ErrorMessage="请选择DDR/Flash/EEPROM/DEMO/Tuner首次使用!" Display="None" DisableExpress='OFR_WY_Review_HD.OrderConfigType =="A类(翻单)"'>DDR</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator66" runat="server" ValidationGroup="产品管理工程师" ControlToValidate="XTextBox26" ErrorMessage='您选择"DDR/Flash/EEPROM/DEMO/Tuner首次使用"为是,请填写内容!' Display="None" DisableExpress='OFR_WY_Review_HD.DDR !="是"'>DDR是</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="106">
                            <aspxform:XRadioButtonList id="XRadioButtonList18" runat="server" XDataBind="OFR_WY_Review_HD.SampleMachine" RepeatDirection="Horizontal">
                                <asp:ListItem>无</asp:ListItem>
                                <asp:ListItem>有</asp:ListItem>
                            </aspxform:XRadioButtonList>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="310" align="left">
                            <div align="right">
                                <aspxform:XLabel id="XLabel35" runat="server" text="DDR/Flash/EEPROM/DEMO/Tuner首次使用"></aspxform:XLabel>
                            </div>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="79">
                            <aspxform:XRadioButtonList id="XRadioButtonList10" runat="server" XDataBind="OFR_WY_Review_HD.DDR" RepeatDirection="Horizontal">
                                <asp:ListItem>否</asp:ListItem>
                                <asp:ListItem>是</asp:ListItem>
                            </aspxform:XRadioButtonList>
                        </td>
        ...
        <div align="center">
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_Review_HD.BOMBPM !="有"' dynamicarea="1,1">
                <tbody>
                    <tr>
            ...
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_Review_HD.SealedMaterial !="有"' dynamicarea="1,1">
                <tbody>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" height="27" width="850" colspan="2">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator46" runat="server" ValidationGroup="软件签单工程师" ControlToValidate="XTextBox60" ErrorMessage="请填写软件评审中的软件编译完成时间！" Display="None" DisableExpress='OFR_WY_Review_Software.OrderSoftwareType !="A类(翻单)"'>软件编译完成时间</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator55" runat="server" ValidationGroup="软件签单工程师" ControlToValidate="XTextBox130" ErrorMessage="请填写软件评审中的同订单！" Display="None" DisableExpress='OFR_WY_Review_Software.OrderSoftwareType !="A类(翻单)"'>同订单</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator56" runat="server" ValidationGroup="软件签单工程师" ControlToValidate="XTextBox59" ErrorMessage="请填写软件评审中的订单软件发布时间！" Display="None" DisableExpress='OFR_WY_Review_Software.OrderSoftwareType =="A类(翻单)" || OFR_WY_Review_Software.OrderSoftwareType ==""'>订单软件发布时间</aspxform:XRequiredFieldValidator>
                            <font color="red"></font></td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="122">
                            <aspxform:XLabel id="XLabel115" runat="server" text="说明书软件提供时间：" HiddenExpress='OFR_WY_Review_Software.SpecificationChange == "无"'></aspxform:XLabel>
                        </td>
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="224">
        ...
        <div style="VISIBILITY: visible" align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_Review_Struct.StructSelect == "" || OFR_WY_Review_Struct.StructSelect =="增加物料" || OFR_WY_Review_Struct.StructSelect =="删除物料" ||OFR_WY_Review_Struct.StructSelect =="增加物料,删除物料"' dynamicarea="0,1">
                <tbody>
                    <tr>
        ...
        <div style="VISIBILITY: visible" align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_Review_Struct.StructSelect == "" || OFR_WY_Review_Struct.StructSelect =="物料替换" || OFR_WY_Review_Struct.StructSelect =="删除物料" ||OFR_WY_Review_Struct.StructSelect =="物料替换,删除物料"' dynamicarea="0,1">
                <tbody>
                    <tr>
        ...
        <div style="VISIBILITY: visible" align="center">
            <table style="BORDER-LEFT: black 1px solid; BORDER-RIGHT: black 1px solid" border="0" cellspacing="0" cellpadding="0" width="1250" hiddenexpress='OFR_WY_Review_Struct.StructSelect == "" || OFR_WY_Review_Struct.StructSelect =="物料替换" || OFR_WY_Review_Struct.StructSelect =="增加物料" ||OFR_WY_Review_Struct.StructSelect =="物料替换,增加物料"' dynamicarea="0,1">
                <tbody>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: #d1dedf 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: #d1dedf 1px solid; BORDER-RIGHT: #d1dedf 1px solid" width="431">
                            ...
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator45" runat="server" ValidationGroup="PMC" ControlToValidate="XDateTimePicker8" ErrorMessage="您在交期评审中选择了撤销计划时间为有，请填写！" Display="None" DisableExpress='OFR_WY_Review_DeliveryDate.RevocationPlan !="有"'>撤销计划时间</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="BORDER-BOTTOM: red 1px solid; BORDER-LEFT: #d1dedf 1px solid; BORDER-TOP: medium none; BORDER-RIGHT: #d1dedf 1px solid" width="1161">
                            <aspxform:XRadioButtonList id="XRadioButtonList19" runat="server" XDataBind="OFR_WY_Review_Financial.Approve" RepeatDirection="Horizontal">
                                <asp:ListItem>无需特批</asp:ListItem>
                                <asp:ListItem>需终审人特批</asp:ListItem>
                            </aspxform:XRadioButtonList>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator71" runat="server" ValidationGroup="财务评审" ControlToValidate="XTextBox111" ErrorMessage="请填写评审意见！" Display="None">评审意见</aspxform:XRequiredFieldValidator>
                            <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator70" runat="server" ValidationGroup="财务评审" ControlToValidate="XRadioButtonList19" ErrorMessage="请选择是否需要特批！" Display="None">特批</aspxform:XRequiredFieldValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
