...
YZSoft.BPM.TimeoutDetailPanel = Ext.extend(Ext.Panel, {
    WorkDayHours: 8,
    constructor: function (config) {
        ...
        this.store = new YZSoft.Data.JsonStore({
            ...
            proxy: new Ext.data.HttpProxy({
                method: 'GET',
                url: 'YZSoft/BPM/StoreDataService/TimeoutDetail.ashx'
            }),
            listeners: {
                scope: this,
                beforeload: function () {
        ...
        YZSoft.BPM.TimeoutDetailPanel.superclass.constructor.call(this, cfg);
    },

    initComponent: function () {
        YZSoft.BPM.TimeoutDetailPanel.superclass.initComponent.call(this);
    },
