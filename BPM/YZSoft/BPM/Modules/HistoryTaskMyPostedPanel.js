...
YZSoft.BPM.HistoryTaskMyPostedPanel = Ext.extend(Ext.Panel, {
    constructor: function (config) {

        this.store = new YZSoft.BPM.Store.HistoryTaskStore({
            baseParams: { limit: YZSoft.EnvSetting.PageSize.BPM.historyMyPosted, HistoryTaskType: 'MyRequest', SpecProcessName: config.SpecProcessName, byYear: config.byYear === false ? 0 : 1 },
            listeners: {
                scope: this,
                beforeload: function () {
        ...
        YZSoft.BPM.HistoryTaskMyPostedPanel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function () {
        YZSoft.BPM.HistoryTaskMyPostedPanel.superclass.initComponent.call(this);
        this.updateStatus();
    },
