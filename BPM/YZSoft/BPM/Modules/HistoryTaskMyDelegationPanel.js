...
YZSoft.BPM.HistoryTaskMyDelegationPanel = Ext.extend(Ext.Panel, {
    constructor: function (config) {

        this.store = new YZSoft.BPM.Store.HistoryTaskStore({
            baseParams: { limit: YZSoft.EnvSetting.PageSize.BPM.historyMyPosted, HistoryTaskType: 'DelegationRequest', SpecProcessName: config.SpecProcessName, byYear: config.byYear === false ? 0 : 1 },
            listeners: {
                scope: this,
                beforeload: function () {
        ...
        this.btnPickbackRestart = new Ext.Button({
            iconCls: 'blist',
            text: RS.$('YZStrings.BPM_OpBtn_Pickback'),
            scope: this,
            handler: function () {
                YZSoft.BPM.TaskOption.PickbackRestart(this.grid);
            }
        });
        ...
        this.searchField = new YZSoft.Form.SearchField({
            ...
            handler: function (advBtn) {
                this.dlg = YZSoft.DialogManager.ShowDialogExt(config.id + '-dlgs',
                    ...
                    { disablePostUserAccount: true, SpecProcessName: this.SpecProcessName, byYear: this.byYear!==false },
        ...
        var cfg = {
            ...
            layout: 'border',
            items: [this.grid],
            tbar: [this.btnPickbackRestart, '|', this.btnPublic, '|', this.btnMore, '|', this.btnTrace, '->', this.btnClear, ' ', this.periodPicker, ' ', this.cmbProcessName, ' ', this.searchField],
            listeners: {
                scope: this,
                activate: function () {
                    if (!this.loaded) {
        ...
        YZSoft.BPM.HistoryTaskMyDelegationPanel.superclass.constructor.call(this, cfg);
    ...
    initComponent: function () {
        YZSoft.BPM.HistoryTaskMyDelegationPanel.superclass.initComponent.call(this);
        this.updateStatus();
    },
    ...
    updateStatus: function () {
        ...
        this.btnPickbackRestart.setDisabled(!pickbackRestart);
