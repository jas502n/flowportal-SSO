<%@ WebHandler Language="C#" Class="YZSoft.BPM.StoreDataService.FormTemplateData" %>
...
{
    public class FormTemplateData : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            using (BPMConnection cn = new BPMConnection())
            {
                ...
                drafts = cn.GetMyDrafts(DraftType.FormTemplate, null, queryProvider.SortStringDraftGrid, gridPageInfo.Start, gridPageInfo.Limit, out rowcount);
