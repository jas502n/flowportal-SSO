...
namespace BPMApp
{
    public class MainModuleTree : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            item.Attributes["dataURL"] = "BPM/BPMModuleTree.ashx";
            ...
            item.Attributes["dataURL"] = "BPM/RPTModuleTree.ashx";
            ...
            item.Attributes["dataURL"] = "BPM/IMModuleTree.ashx";
            ...
            item.Attributes["dataURL"] = "BPM/SYSModuleTree.ashx";
