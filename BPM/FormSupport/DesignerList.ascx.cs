...
using System.Text;
public partial class DesignerList : skyListView
{
    ...
    public override string GetSQL()
    {
       ...
       // if (String.IsNullOrEmpty(col1))
        ...
        // return sb.ToString();
       // return String.Format("SELECT City,ZS,BZ,Country FROM V_Fin_City_Criterion WHERE ParentID = {0} and  CriterionType = '{1}'", this._tree.SelectedNode.Value, col1.Replace(";", "','"));

       // return String.Format("SELECT HRID , Name ,Dept , FullName from dbo.HD_Applicant_Designer");
        return String.Format("SELECT HRID+'(' + Name + ')',HRID, Name ,Dept , FullName from dbo.HD_Applicant_Designer ");
    }
