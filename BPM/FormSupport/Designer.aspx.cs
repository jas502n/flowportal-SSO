...
public partial class FormSupport_Designer : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this._bs.OnClientClick = String.Format("F_CloseDialogA(mlist,{0},'{1}','{2}');return false;",
       ...
       // this._list.TreeView = this._tree.TreeView;
        ...
        string cnString = WebConfigurationManager.ConnectionStrings["BPMDBConnectionString"].ConnectionString;
