<%@ WebHandler Language="C#" Class="YZService" %>
...
//FlowPortal BPM Web Service
//Version:3.4

public class YZService : IHttpHandler
{
    ...
    public virtual void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            if (String.IsNullOrEmpty(UserAccount))
                throw new Exception("UserAccount参数不能为空");

            if (!SetAuth(UserAccount))
                throw new Exception(String.Format("账号【{0}】登陆BPM失败", UserAccount));
