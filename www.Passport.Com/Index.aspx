<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Joson.SSO.Passport.Index" %>
...
<head runat="server">
    ...
    <script src="Jscript/jquery.KinSlideshow-1.1.js" type="text/javascript"></script>
    ...
    <form id="TheForm" runat="server">
        <div>
            <div style="width: 990px; height: 55px; position: relative; margin: 0 auto;">
                ...
                <div style="position: absolute; text-align: right; bottom: 3px; right: 1px; float: right">
            ...
            <div id="menu" style="width: 990px; position: inherit; margin: 0 auto;">
                <ul class="menu">
                    <li><a href="index.aspx" class="parent"><span>首页</span></a></li>
                    <li><a href="http://ehome.digital.com/ArticleList.aspx?ArticleType=通知公告" class="parent"><span>通知公告</span></a></li>
                    <li><a href="http://ehome.digital.com/ArticleList.aspx?ArticleType=公司动态" class="parent"><span>公司动态</span></a></li>
                    <li><a href="http://ehome.digital.com/ArticleList.aspx?ArticleType=员工天地" class="parent"><span>员工天地</span></a></li>
                    <li><a href="#"><span>常用信息</span></a>
                        <ul>
                            <li><a href="http://ehome.digital.com/DocumentShow.aspx?ArticleType=常用表单" target="_self"><span>常用表单</span></a></li>
                            <li><a href="http://ehome.digital.com/DocumentShow.aspx?ArticleType=制度文件" target="_self"><span>制度文件</span></a></li>
                            <%--<li><a href="#" target="_self" onclick="alert('正在建设中...');"><span>办事指南</span></a></li>--%>
                        </ul>
                    </li>
                    <li><a href="http://ehome.digital.com/AddressBook.aspx" class="parent"><span>数字通讯录</span></a></li>
                    ...
                    <asp:Repeater ID="RepeaterPic" runat="server">
                        <ItemTemplate>
                            <a href="<%#(string.IsNullOrEmpty(Eval("H_PageUrl").ToString())?"#": Eval("H_PageUrl").ToString())%>">
                                <img src="http://ehome.digital.com/Home/images/ImgHome/<%# Eval("H_PicUrl") %>" alt="<%# Eval("H_Title") %>"
            ...
            <div style="position: relative; margin: 0 auto; width: 990px; height: 245px; border-bottom: 1px solid #e8e9eb; background: url(Images/title_bg.jpg) #f8f9fb top repeat-x;">
                <div style="width: 980px; line-height: 2em; padding: 0 5px; margin: 0 auto;">
                    <div style="width: 370px; float: left; height: 240px; padding-top: 7px; position: relative; line-height: 2em;">
                        <div style="height: 16px; line-height: 16px; font-weight: bold; color: #195A94; margin-left: 10px; padding: 0 0 0 10px; border-left: 4px solid #195A94;">
                            通知公告 <a style="position: absolute; text-align: right; right: 28px;" target="_self"
                                href="http://ehome.digital.com/ArticleList.aspx?ArticleType=通知公告">更多...</a>
                        </div>
                        <div>
                            <asp:Repeater ID="RepeaterGG" runat="server">
                                ...
                                <ItemTemplate>
                                    <li style="padding-left: 10px; background: <%# Eval("IsNew").ToString()=="1" ? "url(images/newgif.gif)": "url(images/new_point.png)"%> left 12px no-repeat;">
                                        <span style="color: #48A682">
                                            <%# Eval("IsNew").ToString() == "1" ? "&nbsp;&nbsp;&nbsp;" + Eval("AddDate", "{0:yy-MM-dd}") : Eval("AddDate", "{0:yyyy-MM-dd}")%></span>&nbsp;<a
                                                href="http://ehome.digital.com/ArticleShow.aspx?ArticleID=<%# Eval("ArticleID")%>" target="_blank" title="<%# Eval("ArticleTitle")%>">
                    ...
                    <div style="width: 370px; float: left; height: 240px; padding-top: 7px; position: relative; background: url(Images/line_bg.gif) left repeat-y;">
                        <div style="height: 16px; line-height: 16px; font-weight: bold; color: #195A94; margin-left: 10px; padding: 0 0 0 10px; border-left: 4px solid #195A94;">
                            公司动态 <a style="position: absolute; text-align: right; right: 28px;" target="_self"
                                href="http://ehome.digital.com/ArticleList.aspx?ArticleType=公司动态">更多...</a>
                        </div>
                        <div>
                    ...
                    <div style="width: 238px; float: left; height: 240px; padding-top: 7px; position: relative; background: url(images/line_bg.gif) left repeat-y;">
                        <div style="height: 16px; line-height: 16px; font-weight: bold; color: #195A94; margin-left: 10px; padding: 0 0 0 10px; border-left: 4px solid #195A94;">
                            ...
                            <table style="width: 230px; text-align: left;" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="height: 35px; width: 120px; vertical-align: bottom;">
                                        <a href="http://BPM.SDT.com/" target="_blank">BPM业务管理系统</a>
                                    </td>
                                ...
                                <tr>
                                    <td style="height: 23px; vertical-align: bottom;">
                                        <a href="http://EHR.SDT.COM/app/index.aspx" target="_blank">E-HR管理系统</a>
                                    </td>
                                    <td style="vertical-align: bottom;">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: bottom;">
                                        <a href="http://ede.sdt.com:8080/" target="_blank">EDE查询</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 23px; vertical-align: bottom;">
            ...
            <div style="position: relative; margin: 0 auto; width: 990px; height: 240px; border-bottom: 1px solid #e8e9eb; background: url(Images/title_bg.jpg) #f8f9fb top repeat-x;">
                <div style="width: 980px; line-height: 2em; padding: 0 5px; margin: 0 auto;">
                    <div style="width: 740px; float: left; height: 235px; padding-top: 7px; position: relative; line-height: 2em;">
                        <div style="height: 16px; line-height: 16px; font-weight: bold; color: #195A94; margin-left: 10px; padding: 0 0 0 10px; border-left: 4px solid #195A94;">
                            员工天地 <a style="position: absolute; text-align: right; left: 305px;" target="_self"
                                href="http://http://ehome.digital.com/ArticleList.aspx?ArticleType=员工天地">更多...</a>
                        </div>
                        <div>
                    ...
                    <div style="width: 238px; float: left; height: 235px; padding-top: 7px; position: relative; background: url(images/line_bg.gif) left repeat-y;">
                        <div style="height: 16px; line-height: 16px; font-weight: bold; color: #195A94; margin-left: 10px; padding: 0 0 0 10px; border-left: 4px solid #195A94;">
                            其他资源
                        </div>
