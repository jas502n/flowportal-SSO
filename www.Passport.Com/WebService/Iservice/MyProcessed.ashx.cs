...
namespace iAnywhere.YZSoft.services
{
    ...
    /// MyProcessed 的摘要说明
    /// </summary>
    public class MyProcessed : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            using (BPMConnection cn = new BPMConnection())
            {
                ...
                tasks = cn.GetHistoryTasks(year, HistoryTaskType.MyProcessed, dbProvider.FilterStringHistoryTaskTaskTableFilter, dbProvider.FilterStringHistoryTaskStepTableFilter, null, gridPageInfo.Start, gridPageInfo.Limit, out rowcount);
