...
namespace iAnywhere.YZSoft.services
{
    ...
    /// MyRequests 的摘要说明
    /// </summary>
    public class MyRequests : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            using (BPMConnection cn = new BPMConnection())
            {
                ...
                tasks = cn.GetHistoryTasks(year, HistoryTaskType.MyRequest, dbProvider.FilterStringHistoryTaskTaskTableFilter, dbProvider.FilterStringHistoryTaskStepTableFilter, null, gridPageInfo.Start, gridPageInfo.Limit, out rowcount);
