...
namespace Joson.SSOSite.OAuthX
{
    #region 知识点
   ...
   * * */
    ...
    public class BaseController : Controller
    {
        ...
        {
            String PassportBackURL = String.Empty;
            ...
            PassportBackURL = "{0}?BackURL={1}".WithFormat(GetToken, Server.UrlEncode(url));
